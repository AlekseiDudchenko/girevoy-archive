...
export function renderIndex({ stats, competitions, L, bare }) {
  ...
  return page({
    bare,
    title: 'Протоколы и результаты по гиревому спорту | Все гири',
    description: 'Протоколы и результаты соревнований по гиревому спорту: чемпионаты и Кубки России, спортсмены, тренеры и история выступлений.'
    L, active: 'home',
    body: `
<section class="hero">
