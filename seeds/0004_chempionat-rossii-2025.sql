...
INSERT INTO athletes (last_name, first_name, middle_name, birth_year, sex, region_id, club_id, coach, sport_rank_id)
  ...
  WHERE NOT EXISTS (SELECT 1 FROM athletes a WHERE a.last_name = 'Сукманов' AND a.first_name = 'Александр' AND a.middle_name = 'Александрович' AND a.birth_year = 1985);
INSERT INTO athletes (last_name, first_name, middle_name, birth_year, sex, region_id, club_id, coach, sport_rank_id)
...
INSERT INTO athletes (last_name, first_name, middle_name, birth_year, sex, region_id, club_id, coach, sport_rank_id)
  ...
  WHERE NOT EXISTS (SELECT 1 FROM athletes a WHERE a.last_name = 'Афонин' AND a.first_name = 'Игорь' AND a.middle_name = 'Андреевич' AND a.birth_year = 1992);
INSERT INTO athletes (last_name, first_name, middle_name, birth_year, sex, region_id, club_id, coach, sport_rank_id)
...
INSERT INTO athletes (last_name, first_name, middle_name, birth_year, sex, region_id, club_id, coach, sport_rank_id)
  ...
  WHERE NOT EXISTS (SELECT 1 FROM athletes a WHERE a.last_name = 'Кичимаев' AND a.first_name = 'Николай' AND a.middle_name = 'Леонидович' AND a.birth_year = 1987);
INSERT INTO athletes (last_name, first_name, middle_name, birth_year, sex, region_id, club_id, coach, sport_rank_id)
...
INSERT INTO athletes (last_name, first_name, middle_name, birth_year, sex, region_id, club_id, coach, sport_rank_id)
  ...
  WHERE NOT EXISTS (SELECT 1 FROM athletes a WHERE a.last_name = 'Курочкин' AND a.first_name = 'Никита' AND a.middle_name = 'Антонович' AND a.birth_year = 2008);
INSERT INTO athletes (last_name, first_name, middle_name, birth_year, sex, region_id, club_id, coach, sport_rank_id)
  ...
  WHERE NOT EXISTS (SELECT 1 FROM athletes a WHERE a.last_name = 'Беликова' AND a.first_name = 'Олеся' AND a.middle_name = 'Валерьевна' AND a.birth_year = 2004);
INSERT INTO athletes (last_name, first_name, middle_name, birth_year, sex, region_id, club_id, coach, sport_rank_id)
  ...
  WHERE NOT EXISTS (SELECT 1 FROM athletes a WHERE a.last_name = 'Мажаева' AND a.first_name = 'Наталия' AND a.middle_name = 'Евгеньевна' AND a.birth_year = 1999);
INSERT INTO athletes (last_name, first_name, middle_name, birth_year, sex, region_id, club_id, coach, sport_rank_id)
...
INSERT INTO athletes (last_name, first_name, middle_name, birth_year, sex, region_id, club_id, coach, sport_rank_id)
  ...
  WHERE NOT EXISTS (SELECT 1 FROM athletes a WHERE a.last_name = 'Бахтова' AND a.first_name = 'Ирина' AND a.middle_name = 'Игоревна' AND a.birth_year = 1999);
INSERT INTO athletes (last_name, first_name, middle_name, birth_year, sex, region_id, club_id, coach, sport_rank_id)
...
INSERT INTO athletes (last_name, first_name, middle_name, birth_year, sex, region_id, club_id, coach, sport_rank_id)
  ...
  WHERE NOT EXISTS (SELECT 1 FROM athletes a WHERE a.last_name = 'Карпова' AND a.first_name = 'Анна' AND a.middle_name = 'Евгеньевна' AND a.birth_year = 2003);
INSERT INTO athletes (last_name, first_name, middle_name, birth_year, sex, region_id, club_id, coach, sport_rank_id)
...
INSERT INTO athletes (last_name, first_name, middle_name, birth_year, sex, region_id, club_id, coach, sport_rank_id)
  ...
  WHERE NOT EXISTS (SELECT 1 FROM athletes a WHERE a.last_name = 'Кожеватова' AND a.first_name = 'Василиса' AND a.middle_name = 'Егоровна' AND a.birth_year = 2002);
INSERT INTO athletes (last_name, first_name, middle_name, birth_year, sex, region_id, club_id, coach, sport_rank_id)
  ...
  WHERE NOT EXISTS (SELECT 1 FROM athletes a WHERE a.last_name = 'Уржумцева' AND a.first_name = 'Светлана' AND a.middle_name = 'Алексеевна' AND a.birth_year = 1992);
INSERT INTO athletes (last_name, first_name, middle_name, birth_year, sex, region_id, club_id, coach, sport_rank_id)
...
INSERT INTO athletes (last_name, first_name, middle_name, birth_year, sex, region_id, club_id, coach, sport_rank_id)
  ...
  WHERE NOT EXISTS (SELECT 1 FROM athletes a WHERE a.last_name = 'Камалетдинова' AND a.first_name = 'Василя' AND a.middle_name = 'Алмазовна' AND a.birth_year = 2010);
INSERT INTO athletes (last_name, first_name, middle_name, birth_year, sex, region_id, club_id, coach, sport_rank_id)
...
INSERT INTO athletes (last_name, first_name, middle_name, birth_year, sex, region_id, club_id, coach, sport_rank_id)
  ...
  WHERE NOT EXISTS (SELECT 1 FROM athletes a WHERE a.last_name = 'Васькина' AND a.first_name = 'Алина' AND a.middle_name = 'Алексеевна' AND a.birth_year = 1999);
INSERT INTO athletes (last_name, first_name, middle_name, birth_year, sex, region_id, club_id, coach, sport_rank_id)
...
INSERT INTO athletes (last_name, first_name, middle_name, birth_year, sex, region_id, club_id, coach, sport_rank_id)
  ...
  WHERE NOT EXISTS (SELECT 1 FROM athletes a WHERE a.last_name = 'Горячкина' AND a.first_name = 'Лусине' AND a.middle_name = 'Рафиковна' AND a.birth_year = 1984);
INSERT INTO athletes (last_name, first_name, middle_name, birth_year, sex, region_id, club_id, coach, sport_rank_id)
  ...
  WHERE NOT EXISTS (SELECT 1 FROM athletes a WHERE a.last_name = 'Карпушенко' AND a.first_name = 'Ульяна' AND a.middle_name = 'Павловна' AND a.birth_year = 2001);
INSERT INTO athletes (last_name, first_name, middle_name, birth_year, sex, region_id, club_id, coach, sport_rank_id)
...
INSERT INTO athletes (last_name, first_name, middle_name, birth_year, sex, region_id, club_id, coach, sport_rank_id)
  ...
  WHERE NOT EXISTS (SELECT 1 FROM athletes a WHERE a.last_name = 'Шворак' AND a.first_name = 'Алёна' AND a.middle_name = 'Алексеевна' AND a.birth_year = 1994);
INSERT INTO athletes (last_name, first_name, middle_name, birth_year, sex, region_id, club_id, coach, sport_rank_id)
...
INSERT INTO athletes (last_name, first_name, middle_name, birth_year, sex, region_id, club_id, coach, sport_rank_id)
  ...
  WHERE NOT EXISTS (SELECT 1 FROM athletes a WHERE a.last_name = 'Пименова' AND a.first_name = 'Татьяна' AND a.middle_name = 'Дмитриевна' AND a.birth_year = 1997);
INSERT INTO athletes (last_name, first_name, middle_name, birth_year, sex, region_id, club_id, coach, sport_rank_id)
...
INSERT INTO athletes (last_name, first_name, middle_name, birth_year, sex, region_id, club_id, coach, sport_rank_id)
  ...
  WHERE NOT EXISTS (SELECT 1 FROM athletes a WHERE a.last_name = 'Обаранчук' AND a.first_name = 'Ксения' AND a.middle_name = 'Владимировна' AND a.birth_year = 2005);
INSERT INTO athletes (last_name, first_name, middle_name, birth_year, sex, region_id, club_id, coach, sport_rank_id)
  ...
  WHERE NOT EXISTS (SELECT 1 FROM athletes a WHERE a.last_name = 'Каприна' AND a.first_name = 'Наталья' AND a.middle_name = 'Владимировна' AND a.birth_year = 1980);
INSERT INTO athletes (last_name, first_name, middle_name, birth_year, sex, region_id, club_id, coach, sport_rank_id)
...
INSERT INTO athletes (last_name, first_name, middle_name, birth_year, sex, region_id, club_id, coach, sport_rank_id)
  ...
  WHERE NOT EXISTS (SELECT 1 FROM athletes a WHERE a.last_name = 'Миронова' AND a.first_name = 'Василиса' AND a.middle_name = 'Александровна' AND a.birth_year = 2004);
INSERT INTO athletes (last_name, first_name, middle_name, birth_year, sex, region_id, club_id, coach, sport_rank_id)
  ...
  WHERE NOT EXISTS (SELECT 1 FROM athletes a WHERE a.last_name = 'Коневец' AND a.first_name = 'Екатерина' AND a.middle_name = 'Антоновна' AND a.birth_year = 1986);
INSERT INTO athletes (last_name, first_name, middle_name, birth_year, sex, region_id, club_id, coach, sport_rank_id)
  ...
  WHERE NOT EXISTS (SELECT 1 FROM athletes a WHERE a.last_name = 'Бофонова' AND a.first_name = 'Дарья' AND a.middle_name = 'Павловна' AND a.birth_year = 1991);
INSERT INTO athletes (last_name, first_name, middle_name, birth_year, sex, region_id, club_id, coach, sport_rank_id)
...
INSERT INTO athletes (last_name, first_name, middle_name, birth_year, sex, region_id, club_id, coach, sport_rank_id)
  ...
  WHERE NOT EXISTS (SELECT 1 FROM athletes a WHERE a.last_name = 'Насонова' AND a.first_name = 'Виктория' AND a.middle_name = 'Борисовна' AND a.birth_year = 1999);
INSERT INTO athletes (last_name, first_name, middle_name, birth_year, sex, region_id, club_id, coach, sport_rank_id)
...
INSERT INTO athletes (last_name, first_name, middle_name, birth_year, sex, region_id, club_id, coach, sport_rank_id)
  ...
  WHERE NOT EXISTS (SELECT 1 FROM athletes a WHERE a.last_name = 'Кашапова' AND a.first_name = 'Розана' AND a.middle_name = 'Фиргатовна' AND a.birth_year = 2001);
INSERT INTO athletes (last_name, first_name, middle_name, birth_year, sex, region_id, club_id, coach, sport_rank_id)
  ...
  WHERE NOT EXISTS (SELECT 1 FROM athletes a WHERE a.last_name = 'Круглова' AND a.first_name = 'Виктория' AND a.middle_name = 'Денисовна' AND a.birth_year = 2004);
INSERT INTO athletes (last_name, first_name, middle_name, birth_year, sex, region_id, club_id, coach, sport_rank_id)
  ...
  WHERE NOT EXISTS (SELECT 1 FROM athletes a WHERE a.last_name = 'Карандеева' AND a.first_name = 'Юлия' AND a.middle_name = 'Александровна' AND a.birth_year = 2010);
INSERT INTO athletes (last_name, first_name, middle_name, birth_year, sex, region_id, club_id, coach, sport_rank_id)
  ...
  WHERE NOT EXISTS (SELECT 1 FROM athletes a WHERE a.last_name = 'Макарова' AND a.first_name = 'Дарья' AND a.middle_name = 'Андреевна' AND a.birth_year = 2007);
INSERT INTO athletes (last_name, first_name, middle_name, birth_year, sex, region_id, club_id, coach, sport_rank_id)
  ...
  WHERE NOT EXISTS (SELECT 1 FROM athletes a WHERE a.last_name = 'Шумилейко' AND a.first_name = 'Ангелина' AND a.middle_name = 'Викторовна' AND a.birth_year = 2003);
INSERT INTO athletes (last_name, first_name, middle_name, birth_year, sex, region_id, club_id, coach, sport_rank_id)
  ...
  WHERE NOT EXISTS (SELECT 1 FROM athletes a WHERE a.last_name = 'Сергеева' AND a.first_name = 'Вероника' AND a.middle_name = 'Алексеевна' AND a.birth_year = 2010);
INSERT INTO athletes (last_name, first_name, middle_name, birth_year, sex, region_id, club_id, coach, sport_rank_id)
  ...
  WHERE NOT EXISTS (SELECT 1 FROM athletes a WHERE a.last_name = 'Киселева' AND a.first_name = 'Камила' AND a.middle_name = 'Алексеевна' AND a.birth_year = 2011);
...
INSERT INTO athlete_slugs (slug, athlete_id)
  SELECT CASE WHEN EXISTS (SELECT 1 FROM athlete_slugs s WHERE s.slug = 'sukmanov-aleksandr-1985' AND s.athlete_id <> a.id)
    ...
    FROM athletes a WHERE a.id = (SELECT id FROM athletes WHERE last_name = 'Сукманов' AND first_name = 'Александр' AND middle_name = 'Александрович' AND birth_year = 1985)
     AND NOT EXISTS (SELECT 1 FROM athlete_slugs s2 WHERE s2.athlete_id = a.id);
INSERT INTO athlete_slugs (slug, athlete_id)
...
INSERT INTO athlete_slugs (slug, athlete_id)
  SELECT CASE WHEN EXISTS (SELECT 1 FROM athlete_slugs s WHERE s.slug = 'afonin-igor-1992' AND s.athlete_id <> a.id)
    ...
    FROM athletes a WHERE a.id = (SELECT id FROM athletes WHERE last_name = 'Афонин' AND first_name = 'Игорь' AND middle_name = 'Андреевич' AND birth_year = 1992)
     AND NOT EXISTS (SELECT 1 FROM athlete_slugs s2 WHERE s2.athlete_id = a.id);
INSERT INTO athlete_slugs (slug, athlete_id)
...
INSERT INTO athlete_slugs (slug, athlete_id)
  SELECT CASE WHEN EXISTS (SELECT 1 FROM athlete_slugs s WHERE s.slug = 'kichimaev-nikolay-1987' AND s.athlete_id <> a.id)
    ...
    FROM athletes a WHERE a.id = (SELECT id FROM athletes WHERE last_name = 'Кичимаев' AND first_name = 'Николай' AND middle_name = 'Леонидович' AND birth_year = 1987)
     AND NOT EXISTS (SELECT 1 FROM athlete_slugs s2 WHERE s2.athlete_id = a.id);
INSERT INTO athlete_slugs (slug, athlete_id)
...
INSERT INTO athlete_slugs (slug, athlete_id)
  SELECT CASE WHEN EXISTS (SELECT 1 FROM athlete_slugs s WHERE s.slug = 'kurochkin-nikita-2008' AND s.athlete_id <> a.id)
    ...
    FROM athletes a WHERE a.id = (SELECT id FROM athletes WHERE last_name = 'Курочкин' AND first_name = 'Никита' AND middle_name = 'Антонович' AND birth_year = 2008)
     AND NOT EXISTS (SELECT 1 FROM athlete_slugs s2 WHERE s2.athlete_id = a.id);
INSERT INTO athlete_slugs (slug, athlete_id)
  SELECT CASE WHEN EXISTS (SELECT 1 FROM athlete_slugs s WHERE s.slug = 'belikova-olesya-2004' AND s.athlete_id <> a.id)
    ...
    FROM athletes a WHERE a.id = (SELECT id FROM athletes WHERE last_name = 'Беликова' AND first_name = 'Олеся' AND middle_name = 'Валерьевна' AND birth_year = 2004)
     AND NOT EXISTS (SELECT 1 FROM athlete_slugs s2 WHERE s2.athlete_id = a.id);
INSERT INTO athlete_slugs (slug, athlete_id)
  SELECT CASE WHEN EXISTS (SELECT 1 FROM athlete_slugs s WHERE s.slug = 'mazhaeva-nataliya-1999' AND s.athlete_id <> a.id)
    ...
    FROM athletes a WHERE a.id = (SELECT id FROM athletes WHERE last_name = 'Мажаева' AND first_name = 'Наталия' AND middle_name = 'Евгеньевна' AND birth_year = 1999)
     AND NOT EXISTS (SELECT 1 FROM athlete_slugs s2 WHERE s2.athlete_id = a.id);
INSERT INTO athlete_slugs (slug, athlete_id)
...
INSERT INTO athlete_slugs (slug, athlete_id)
  SELECT CASE WHEN EXISTS (SELECT 1 FROM athlete_slugs s WHERE s.slug = 'bahtova-irina-1999' AND s.athlete_id <> a.id)
    ...
    FROM athletes a WHERE a.id = (SELECT id FROM athletes WHERE last_name = 'Бахтова' AND first_name = 'Ирина' AND middle_name = 'Игоревна' AND birth_year = 1999)
     AND NOT EXISTS (SELECT 1 FROM athlete_slugs s2 WHERE s2.athlete_id = a.id);
INSERT INTO athlete_slugs (slug, athlete_id)
...
INSERT INTO athlete_slugs (slug, athlete_id)
  SELECT CASE WHEN EXISTS (SELECT 1 FROM athlete_slugs s WHERE s.slug = 'karpova-anna-2003' AND s.athlete_id <> a.id)
    ...
    FROM athletes a WHERE a.id = (SELECT id FROM athletes WHERE last_name = 'Карпова' AND first_name = 'Анна' AND middle_name = 'Евгеньевна' AND birth_year = 2003)
     AND NOT EXISTS (SELECT 1 FROM athlete_slugs s2 WHERE s2.athlete_id = a.id);
INSERT INTO athlete_slugs (slug, athlete_id)
...
INSERT INTO athlete_slugs (slug, athlete_id)
  SELECT CASE WHEN EXISTS (SELECT 1 FROM athlete_slugs s WHERE s.slug = 'kozhevatova-vasilisa-2002' AND s.athlete_id <> a.id)
    ...
    FROM athletes a WHERE a.id = (SELECT id FROM athletes WHERE last_name = 'Кожеватова' AND first_name = 'Василиса' AND middle_name = 'Егоровна' AND birth_year = 2002)
     AND NOT EXISTS (SELECT 1 FROM athlete_slugs s2 WHERE s2.athlete_id = a.id);
INSERT INTO athlete_slugs (slug, athlete_id)
  SELECT CASE WHEN EXISTS (SELECT 1 FROM athlete_slugs s WHERE s.slug = 'urzhumceva-svetlana-1992' AND s.athlete_id <> a.id)
    ...
    FROM athletes a WHERE a.id = (SELECT id FROM athletes WHERE last_name = 'Уржумцева' AND first_name = 'Светлана' AND middle_name = 'Алексеевна' AND birth_year = 1992)
     AND NOT EXISTS (SELECT 1 FROM athlete_slugs s2 WHERE s2.athlete_id = a.id);
INSERT INTO athlete_slugs (slug, athlete_id)
...
INSERT INTO athlete_slugs (slug, athlete_id)
  SELECT CASE WHEN EXISTS (SELECT 1 FROM athlete_slugs s WHERE s.slug = 'kamaletdinova-vasilya-2010' AND s.athlete_id <> a.id)
    ...
    FROM athletes a WHERE a.id = (SELECT id FROM athletes WHERE last_name = 'Камалетдинова' AND first_name = 'Василя' AND middle_name = 'Алмазовна' AND birth_year = 2010)
     AND NOT EXISTS (SELECT 1 FROM athlete_slugs s2 WHERE s2.athlete_id = a.id);
INSERT INTO athlete_slugs (slug, athlete_id)
...
INSERT INTO athlete_slugs (slug, athlete_id)
  SELECT CASE WHEN EXISTS (SELECT 1 FROM athlete_slugs s WHERE s.slug = 'vaskina-alina-1999' AND s.athlete_id <> a.id)
    ...
    FROM athletes a WHERE a.id = (SELECT id FROM athletes WHERE last_name = 'Васькина' AND first_name = 'Алина' AND middle_name = 'Алексеевна' AND birth_year = 1999)
     AND NOT EXISTS (SELECT 1 FROM athlete_slugs s2 WHERE s2.athlete_id = a.id);
INSERT INTO athlete_slugs (slug, athlete_id)
...
INSERT INTO athlete_slugs (slug, athlete_id)
  SELECT CASE WHEN EXISTS (SELECT 1 FROM athlete_slugs s WHERE s.slug = 'goryachkina-lusine-1984' AND s.athlete_id <> a.id)
    ...
    FROM athletes a WHERE a.id = (SELECT id FROM athletes WHERE last_name = 'Горячкина' AND first_name = 'Лусине' AND middle_name = 'Рафиковна' AND birth_year = 1984)
     AND NOT EXISTS (SELECT 1 FROM athlete_slugs s2 WHERE s2.athlete_id = a.id);
INSERT INTO athlete_slugs (slug, athlete_id)
  SELECT CASE WHEN EXISTS (SELECT 1 FROM athlete_slugs s WHERE s.slug = 'karpushenko-ulyana-2001' AND s.athlete_id <> a.id)
    ...
    FROM athletes a WHERE a.id = (SELECT id FROM athletes WHERE last_name = 'Карпушенко' AND first_name = 'Ульяна' AND middle_name = 'Павловна' AND birth_year = 2001)
     AND NOT EXISTS (SELECT 1 FROM athlete_slugs s2 WHERE s2.athlete_id = a.id);
INSERT INTO athlete_slugs (slug, athlete_id)
...
INSERT INTO athlete_slugs (slug, athlete_id)
  SELECT CASE WHEN EXISTS (SELECT 1 FROM athlete_slugs s WHERE s.slug = 'shvorak-alena-1994' AND s.athlete_id <> a.id)
    ...
    FROM athletes a WHERE a.id = (SELECT id FROM athletes WHERE last_name = 'Шворак' AND first_name = 'Алёна' AND middle_name = 'Алексеевна' AND birth_year = 1994)
     AND NOT EXISTS (SELECT 1 FROM athlete_slugs s2 WHERE s2.athlete_id = a.id);
INSERT INTO athlete_slugs (slug, athlete_id)
...
INSERT INTO athlete_slugs (slug, athlete_id)
  SELECT CASE WHEN EXISTS (SELECT 1 FROM athlete_slugs s WHERE s.slug = 'pimenova-tatyana-1997' AND s.athlete_id <> a.id)
    ...
    FROM athletes a WHERE a.id = (SELECT id FROM athletes WHERE last_name = 'Пименова' AND first_name = 'Татьяна' AND middle_name = 'Дмитриевна' AND birth_year = 1997)
     AND NOT EXISTS (SELECT 1 FROM athlete_slugs s2 WHERE s2.athlete_id = a.id);
INSERT INTO athlete_slugs (slug, athlete_id)
...
INSERT INTO athlete_slugs (slug, athlete_id)
  SELECT CASE WHEN EXISTS (SELECT 1 FROM athlete_slugs s WHERE s.slug = 'obaranchuk-kseniya-2005' AND s.athlete_id <> a.id)
    ...
    FROM athletes a WHERE a.id = (SELECT id FROM athletes WHERE last_name = 'Обаранчук' AND first_name = 'Ксения' AND middle_name = 'Владимировна' AND birth_year = 2005)
     AND NOT EXISTS (SELECT 1 FROM athlete_slugs s2 WHERE s2.athlete_id = a.id);
INSERT INTO athlete_slugs (slug, athlete_id)
  SELECT CASE WHEN EXISTS (SELECT 1 FROM athlete_slugs s WHERE s.slug = 'kaprina-natalya-1980' AND s.athlete_id <> a.id)
    ...
    FROM athletes a WHERE a.id = (SELECT id FROM athletes WHERE last_name = 'Каприна' AND first_name = 'Наталья' AND middle_name = 'Владимировна' AND birth_year = 1980)
     AND NOT EXISTS (SELECT 1 FROM athlete_slugs s2 WHERE s2.athlete_id = a.id);
INSERT INTO athlete_slugs (slug, athlete_id)
...
INSERT INTO athlete_slugs (slug, athlete_id)
  SELECT CASE WHEN EXISTS (SELECT 1 FROM athlete_slugs s WHERE s.slug = 'mironova-vasilisa-2004' AND s.athlete_id <> a.id)
    ...
    FROM athletes a WHERE a.id = (SELECT id FROM athletes WHERE last_name = 'Миронова' AND first_name = 'Василиса' AND middle_name = 'Александровна' AND birth_year = 2004)
     AND NOT EXISTS (SELECT 1 FROM athlete_slugs s2 WHERE s2.athlete_id = a.id);
INSERT INTO athlete_slugs (slug, athlete_id)
  SELECT CASE WHEN EXISTS (SELECT 1 FROM athlete_slugs s WHERE s.slug = 'konevec-ekaterina-1986' AND s.athlete_id <> a.id)
    ...
    FROM athletes a WHERE a.id = (SELECT id FROM athletes WHERE last_name = 'Коневец' AND first_name = 'Екатерина' AND middle_name = 'Антоновна' AND birth_year = 1986)
     AND NOT EXISTS (SELECT 1 FROM athlete_slugs s2 WHERE s2.athlete_id = a.id);
INSERT INTO athlete_slugs (slug, athlete_id)
  SELECT CASE WHEN EXISTS (SELECT 1 FROM athlete_slugs s WHERE s.slug = 'bofonova-darya-1991' AND s.athlete_id <> a.id)
    ...
    FROM athletes a WHERE a.id = (SELECT id FROM athletes WHERE last_name = 'Бофонова' AND first_name = 'Дарья' AND middle_name = 'Павловна' AND birth_year = 1991)
     AND NOT EXISTS (SELECT 1 FROM athlete_slugs s2 WHERE s2.athlete_id = a.id);
INSERT INTO athlete_slugs (slug, athlete_id)
...
INSERT INTO athlete_slugs (slug, athlete_id)
  SELECT CASE WHEN EXISTS (SELECT 1 FROM athlete_slugs s WHERE s.slug = 'nasonova-viktoriya-1999' AND s.athlete_id <> a.id)
    ...
    FROM athletes a WHERE a.id = (SELECT id FROM athletes WHERE last_name = 'Насонова' AND first_name = 'Виктория' AND middle_name = 'Борисовна' AND birth_year = 1999)
     AND NOT EXISTS (SELECT 1 FROM athlete_slugs s2 WHERE s2.athlete_id = a.id);
INSERT INTO athlete_slugs (slug, athlete_id)
...
INSERT INTO athlete_slugs (slug, athlete_id)
  SELECT CASE WHEN EXISTS (SELECT 1 FROM athlete_slugs s WHERE s.slug = 'kashapova-rozana-2001' AND s.athlete_id <> a.id)
    ...
    FROM athletes a WHERE a.id = (SELECT id FROM athletes WHERE last_name = 'Кашапова' AND first_name = 'Розана' AND middle_name = 'Фиргатовна' AND birth_year = 2001)
     AND NOT EXISTS (SELECT 1 FROM athlete_slugs s2 WHERE s2.athlete_id = a.id);
INSERT INTO athlete_slugs (slug, athlete_id)
  SELECT CASE WHEN EXISTS (SELECT 1 FROM athlete_slugs s WHERE s.slug = 'kruglova-viktoriya-2004' AND s.athlete_id <> a.id)
    ...
    FROM athletes a WHERE a.id = (SELECT id FROM athletes WHERE last_name = 'Круглова' AND first_name = 'Виктория' AND middle_name = 'Денисовна' AND birth_year = 2004)
     AND NOT EXISTS (SELECT 1 FROM athlete_slugs s2 WHERE s2.athlete_id = a.id);
INSERT INTO athlete_slugs (slug, athlete_id)
  SELECT CASE WHEN EXISTS (SELECT 1 FROM athlete_slugs s WHERE s.slug = 'karandeeva-yuliya-2010' AND s.athlete_id <> a.id)
    ...
    FROM athletes a WHERE a.id = (SELECT id FROM athletes WHERE last_name = 'Карандеева' AND first_name = 'Юлия' AND middle_name = 'Александровна' AND birth_year = 2010)
     AND NOT EXISTS (SELECT 1 FROM athlete_slugs s2 WHERE s2.athlete_id = a.id);
INSERT INTO athlete_slugs (slug, athlete_id)
  SELECT CASE WHEN EXISTS (SELECT 1 FROM athlete_slugs s WHERE s.slug = 'makarova-darya-2007' AND s.athlete_id <> a.id)
    ...
    FROM athletes a WHERE a.id = (SELECT id FROM athletes WHERE last_name = 'Макарова' AND first_name = 'Дарья' AND middle_name = 'Андреевна' AND birth_year = 2007)
     AND NOT EXISTS (SELECT 1 FROM athlete_slugs s2 WHERE s2.athlete_id = a.id);
INSERT INTO athlete_slugs (slug, athlete_id)
  SELECT CASE WHEN EXISTS (SELECT 1 FROM athlete_slugs s WHERE s.slug = 'shumileyko-angelina-2003' AND s.athlete_id <> a.id)
    ...
    FROM athletes a WHERE a.id = (SELECT id FROM athletes WHERE last_name = 'Шумилейко' AND first_name = 'Ангелина' AND middle_name = 'Викторовна' AND birth_year = 2003)
     AND NOT EXISTS (SELECT 1 FROM athlete_slugs s2 WHERE s2.athlete_id = a.id);
INSERT INTO athlete_slugs (slug, athlete_id)
  SELECT CASE WHEN EXISTS (SELECT 1 FROM athlete_slugs s WHERE s.slug = 'sergeeva-veronika-2010' AND s.athlete_id <> a.id)
    ...
    FROM athletes a WHERE a.id = (SELECT id FROM athletes WHERE last_name = 'Сергеева' AND first_name = 'Вероника' AND middle_name = 'Алексеевна' AND birth_year = 2010)
     AND NOT EXISTS (SELECT 1 FROM athlete_slugs s2 WHERE s2.athlete_id = a.id);
INSERT INTO athlete_slugs (slug, athlete_id)
  SELECT CASE WHEN EXISTS (SELECT 1 FROM athlete_slugs s WHERE s.slug = 'kiseleva-kamila-2011' AND s.athlete_id <> a.id)
    ...
    FROM athletes a WHERE a.id = (SELECT id FROM athletes WHERE last_name = 'Киселева' AND first_name = 'Камила' AND middle_name = 'Алексеевна' AND birth_year = 2011)
     AND NOT EXISTS (SELECT 1 FROM athlete_slugs s2 WHERE s2.athlete_id = a.id);
...
INSERT INTO results (id, category_id, athlete_id, place, total_reps, points, body_weight_kg, rank_achieved_id, discipline_id, bell_kg, hands, time_limit_min, competition_id, event_date, raw_name, raw_club, raw_region, protocol_id, source_page) VALUES
  ...
  (1305, 1029, (SELECT id FROM athletes WHERE last_name = 'Марков' AND first_name = 'Иван' AND middle_name = 'Эдуардович' AND birth_year = 1995), 1, 221, NULL, 100.45, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 1001, '2025-06-12', 'Марков Иван Эдуардович', 'СПБ ГБУ ДО СШОРСВС им. В.Ф.', 'г. Санкт-Петербург', 1001, 12),
  (1306, 1029, (SELECT id FROM athletes WHERE last_name = 'Орлов' AND first_name = 'Сергей' AND middle_name = 'Александрович' AND birth_year = 2005), 2, 212, NULL, 118.6, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 1001, '2025-06-12', 'Орлов Сергей Александрович', '-', 'Ставропольский край', 1001, 12),
  (1307, 1029, (SELECT id FROM athletes WHERE last_name = 'Денисов' AND first_name = 'Иван' AND middle_name = 'Николаевич' AND birth_year = 1982), 3, 200, NULL, 118.45, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 1001, '2025-06-12', 'Денисов Иван Николаевич', 'РО ООО ВФГС в Челябинской Области', 'Челябинская область', 1001, 12),
  (1308, 1029, (SELECT id FROM athletes WHERE last_name = 'Константинов' AND first_name = 'Александр' AND middle_name = 'Иванович' AND birth_year = 2003), 4, 192, NULL, 116.9, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 1001, '2025-06-12', 'Константинов Александр Иванович', 'СШ Энергия', 'Чувашская Республика', 1001, 12),
  (1309, 1029, (SELECT id FROM athletes WHERE last_name = 'Сукманов' AND first_name = 'Александр' AND middle_name = 'Александрович' AND birth_year = 1985), 5, 192, NULL, 121.2, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 1001, '2025-06-12', 'Сукманов Александр Александрович', 'СК «Нирвана»', 'Курганская область', 1001, 12),
  (1310, 1029, (SELECT id FROM athletes WHERE last_name = 'Шевелев' AND first_name = 'Дмитрий' AND middle_name = 'Владимирович' AND birth_year = 1989), 6, 190, NULL, 114.8, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 1001, '2025-06-12', 'Шевелев Дмитрий Владимирович', 'ВС', 'Новосибирская область', 1001, 12),
  (1311, 1029, (SELECT id FROM athletes WHERE last_name = 'Симашкевич' AND first_name = 'Евгений' AND middle_name = 'Валентинович' AND birth_year = 1991), 7, 187, NULL, 110.75, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 1001, '2025-06-12', 'Симашкевич Евгений Валентинович', 'ВС', 'Омская область', 1001, 12),
  (1312, 1029, (SELECT id FROM athletes WHERE last_name = 'Июльский' AND first_name = 'Дмитрий' AND middle_name = 'Валерьевич' AND birth_year = 1993), 8, 185, NULL, 103.9, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 1001, '2025-06-12', 'Июльский Дмитрий Валерьевич', 'ГБУ ДО МКСШОР «Запад» Отделение', 'г. Москва', 1001, 12),
  (1313, 1029, (SELECT id FROM athletes WHERE last_name = 'Стаханов' AND first_name = 'Валентин' AND middle_name = 'Викторович' AND birth_year = 1990), 9, 177, NULL, 96.4, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 1001, '2025-06-12', 'Стаханов Валентин Викторович', 'ВС', 'Омская область', 1001, 12),
  (1314, 1029, (SELECT id FROM athletes WHERE last_name = 'Носков' AND first_name = 'Андрей' AND middle_name = 'Николаевич' AND birth_year = 1993), 10, 174, NULL, 100.2, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 1001, '2025-06-12', 'Носков Андрей Николаевич', 'МАУ ДО СШ «Прикамье» г. Перми', 'Пермский край', 1001, 12),
  (1315, 1029, (SELECT id FROM athletes WHERE last_name = 'Афонин' AND first_name = 'Игорь' AND middle_name = 'Андреевич' AND birth_year = 1992), 11, 171, NULL, 102.3, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 1001, '2025-06-12', 'Афонин Игорь Андреевич', 'РО ООО "ВФГС" в Нижегородской', 'Нижегородская область', 1001, 12),
  (1316, 1029, (SELECT id FROM athletes WHERE last_name = 'Павлов' AND first_name = 'Александр' AND middle_name = 'Станиславович' AND birth_year = 1994), 12, 164, NULL, 108.65, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 1001, '2025-06-12', 'Павлов Александр Станиславович', 'СШ Энергия', 'Чувашская Республика', 1001, 12),
  (1317, 1029, (SELECT id FROM athletes WHERE last_name = 'Кичимаев' AND first_name = 'Николай' AND middle_name = 'Леонидович' AND birth_year = 1987), 13, 160, NULL, 112.15, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 1001, '2025-06-12', 'Кичимаев Николай Леонидович', 'СПБ ГБУ ДО СШОРСВС им. В.Ф.', 'г. Санкт-Петербург', 1001, 12),
  (1318, 1029, (SELECT id FROM athletes WHERE last_name = 'Балабанов' AND first_name = 'Сергей' AND middle_name = 'Андреевич' AND birth_year = 1996), 14, 150, NULL, 104.8, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 1001, '2025-06-12', 'Балабанов Сергей Андреевич', 'ВС', 'Республика Бурятия', 1001, 12),
  (1319, 1029, (SELECT id FROM athletes WHERE last_name = 'Башаров' AND first_name = 'Нурислам' AND middle_name = 'Магсумович' AND birth_year = 1983), 15, 140, NULL, 108.2, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 1001, '2025-06-12', 'Башаров Нурислам Магсумович', 'РОО ФГС РТ', 'Республика Татарстан', 1001, 12),
  (1320, 1029, (SELECT id FROM athletes WHERE last_name = 'Куликов' AND first_name = 'Владислав' AND middle_name = 'Александрович' AND birth_year = 2006), 16, 134, NULL, 119.25, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 1001, '2025-06-12', 'Куликов Владислав Александрович', 'РО ООО ВФГС в Челябинской области', 'Челябинская область', 1001, 12),
  (1321, 1029, (SELECT id FROM athletes WHERE last_name = 'Курочкин' AND first_name = 'Никита' AND middle_name = 'Антонович' AND birth_year = 2008), 17, 113, NULL, 113.9, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 1001, '2025-06-12', 'Курочкин Никита Антонович', 'МБУ ДО СШ «Татнефть Олимп»', 'Республика Татарстан', 1001, 12),
  (1322, 1029, (SELECT id FROM athletes WHERE last_name = 'Чирков' AND first_name = 'Леонид' AND middle_name = 'Евгеньевич' AND birth_year = 2003), NULL, NULL, NULL, NULL, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 1001, '2025-06-12', 'Чирков Леонид Евгеньевич', 'СШОР "Маршал"', 'Калужская область', 1001, 12),
  (1323, 1030, (SELECT id FROM athletes WHERE last_name = 'Беликова' AND first_name = 'Олеся' AND middle_name = 'Валерьевна' AND birth_year = 2004), 1, 188, NULL, 57.75, (SELECT id FROM sport_ranks WHERE code = 'msmk'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 1001, '2025-06-12', 'Беликова Олеся Валерьевна', 'СШ Юность', 'Белгородская область', 1001, 11),
  (1324, 1030, (SELECT id FROM athletes WHERE last_name = 'Мажаева' AND first_name = 'Наталия' AND middle_name = 'Евгеньевна' AND birth_year = 1999), 2, 185, NULL, 56.5, (SELECT id FROM sport_ranks WHERE code = 'msmk'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 1001, '2025-06-12', 'Мажаева Наталия Евгеньевна', 'СПБ ГБУ ДО СШОРСВС им. В.Ф.', 'г. Санкт-Петербург', 1001, 11),
  (1325, 1030, (SELECT id FROM athletes WHERE last_name = 'Щербина' AND first_name = 'Джанита' AND middle_name = 'Вадимовна' AND birth_year = 1991), 3, 176, NULL, 55.3, (SELECT id FROM sport_ranks WHERE code = 'msmk'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 1001, '2025-06-12', 'Щербина Джанита Вадимовна', 'СПБ ГБУ ДО СШОРСВС им. В.Ф.', 'г. Санкт-Петербург', 1001, 11),
  (1326, 1030, (SELECT id FROM athletes WHERE last_name = 'Жура' AND first_name = 'Александра' AND middle_name = 'Михайловна' AND birth_year = 1988), 4, 174, NULL, 57.3, (SELECT id FROM sport_ranks WHERE code = 'msmk'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 1001, '2025-06-12', 'Жура Александра Михайловна', 'СПБ ГБУ ДО СШОРСВС им. В.Ф.', 'г. Санкт-Петербург', 1001, 11),
  (1327, 1030, (SELECT id FROM athletes WHERE last_name = 'Бахтова' AND first_name = 'Ирина' AND middle_name = 'Игоревна' AND birth_year = 1999), 5, 172, NULL, 56.9, (SELECT id FROM sport_ranks WHERE code = 'msmk'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 1001, '2025-06-12', 'Бахтова Ирина Игоревна', 'ООО РО "ВФГС" СО', 'Самарская область', 1001, 11),
  (1328, 1030, (SELECT id FROM athletes WHERE last_name = 'Ныныч' AND first_name = 'Маргарита' AND middle_name = 'Анатольевна' AND birth_year = 1996), 6, 155, NULL, 57.65, (SELECT id FROM sport_ranks WHERE code = 'msmk'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 1001, '2025-06-12', 'Ныныч Маргарита Анатольевна', 'ВС', 'Республика Бурятия', 1001, 11),
  (1329, 1030, (SELECT id FROM athletes WHERE last_name = 'Хуснудинова' AND first_name = 'Мария' AND middle_name = 'Петровна' AND birth_year = 2004), 7, 146, NULL, 56.1, (SELECT id FROM sport_ranks WHERE code = 'msmk'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 1001, '2025-06-12', 'Хуснудинова Мария Петровна', 'РО ООО ВФГС в Челябинской области', 'Челябинская область', 1001, 11),
  (1330, 1030, (SELECT id FROM athletes WHERE last_name = 'Гладышева' AND first_name = 'Дарья' AND middle_name = 'Алексеевна' AND birth_year = 2004), 8, 140, NULL, 54.55, (SELECT id FROM sport_ranks WHERE code = 'ms'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 1001, '2025-06-12', 'Гладышева Дарья Алексеевна', 'МБУДО " Куртамышская ДЮСШ "', 'Курганская область', 1001, 11),
  (1331, 1030, (SELECT id FROM athletes WHERE last_name = 'Карпова' AND first_name = 'Анна' AND middle_name = 'Евгеньевна' AND birth_year = 2003), 9, 134, NULL, 54.85, (SELECT id FROM sport_ranks WHERE code = 'ms'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 1001, '2025-06-12', 'Карпова Анна Евгеньевна', 'МАУ ЦФОР-РИТМ', 'Тюменская область', 1001, 11),
  (1332, 1030, (SELECT id FROM athletes WHERE last_name = 'Карцова' AND first_name = 'Татьяна' AND middle_name = 'Валерьевна' AND birth_year = 1981), 10, 122, NULL, 57.15, (SELECT id FROM sport_ranks WHERE code = 'ms'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 1001, '2025-06-12', 'Карцова Татьяна Валерьевна', 'онлайн школа ГС "Rudnev&Kettlebells"', 'Московская область', 1001, 11),
  (1333, 1030, (SELECT id FROM athletes WHERE last_name = 'Кожеватова' AND first_name = 'Василиса' AND middle_name = 'Егоровна' AND birth_year = 2002), 11, 120, NULL, 58.0, (SELECT id FROM sport_ranks WHERE code = 'ms'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 1001, '2025-06-12', 'Кожеватова Василиса Егоровна', 'СШ №1 им. Л.Д. Ковалесвкого', 'Оренбургская область', 1001, 11),
  (1334, 1030, (SELECT id FROM athletes WHERE last_name = 'Уржумцева' AND first_name = 'Светлана' AND middle_name = 'Алексеевна' AND birth_year = 1992), 12, 117, NULL, 58.0, (SELECT id FROM sport_ranks WHERE code = 'kms'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 1001, '2025-06-12', 'Уржумцева Светлана Алексеевна', 'Атлет', 'Челябинская область', 1001, 11),
  (1335, 1030, (SELECT id FROM athletes WHERE last_name = 'Белоус' AND first_name = 'Анна' AND middle_name = 'Сергеевна' AND birth_year = 2001), 13, 116, NULL, 54.15, (SELECT id FROM sport_ranks WHERE code = 'kms'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 1001, '2025-06-12', 'Белоус Анна Сергеевна', 'МБУ ДО СШОР «Югория» им. А.А.', 'Ханты-Мансийский АО - Югра', 1001, 11),
  (1336, 1030, (SELECT id FROM athletes WHERE last_name = 'Аллоярова' AND first_name = 'Милана' AND middle_name = 'Борисовна' AND birth_year = 2002), 14, 85, NULL, 57.15, (SELECT id FROM sport_ranks WHERE code = 'kms'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 1001, '2025-06-12', 'Аллоярова Милана Борисовна', 'МАУ ДО "СШ 1" г.Тобольска', 'Тюменская область', 1001, 11),
  (1337, 1030, (SELECT id FROM athletes WHERE last_name = 'Подольская' AND first_name = 'Анастасия' AND middle_name = 'Владимировна' AND birth_year = 2005), 15, 83, NULL, 57.55, (SELECT id FROM sport_ranks WHERE code = 'kms'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 1001, '2025-06-12', 'Подольская Анастасия Владимировна', 'РО ООО «ВФГС» в г. Москве', 'г. Москва', 1001, 11),
  (1338, 1030, (SELECT id FROM athletes WHERE last_name = 'Камалетдинова' AND first_name = 'Василя' AND middle_name = 'Алмазовна' AND birth_year = 2010), 16, 46, NULL, 56.3, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 1001, '2025-06-12', 'Камалетдинова Василя Алмазовна', 'РОО ФГС РТ', 'Республика Татарстан', 1001, 11),
  (1339, 1031, (SELECT id FROM athletes WHERE last_name = 'Степанова' AND first_name = 'Оксана' AND middle_name = 'Анатольевна' AND birth_year = 1990), 1, 202, NULL, 62.45, (SELECT id FROM sport_ranks WHERE code = 'msmk'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 1001, '2025-06-12', 'Степанова Оксана Анатольевна', 'РОООО ВФГС в Челябинской области', 'Челябинская область', 1001, 10),
  (1340, 1031, (SELECT id FROM athletes WHERE last_name = 'Тарвердиева' AND first_name = 'Мария' AND middle_name = 'Алексеевна' AND birth_year = 1986), 2, 191, NULL, 62.4, (SELECT id FROM sport_ranks WHERE code = 'msmk'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 1001, '2025-06-12', 'Тарвердиева Мария Алексеевна', 'СПБ ГБУ ДО СШОРСВС им. В.Ф.', 'г. Санкт-Петербург', 1001, 10),
  (1341, 1031, (SELECT id FROM athletes WHERE last_name = 'Дедюхина' AND first_name = 'Ксения' AND middle_name = 'Игоревна' AND birth_year = 1990), 3, 182, NULL, 61.75, (SELECT id FROM sport_ranks WHERE code = 'msmk'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 1001, '2025-06-12', 'Дедюхина Ксения Игоревна', 'МБУ ДО СШОР «Югория» им. А.А.', 'Ханты-Мансийский АО - Югра', 1001, 10),
  (1342, 1031, (SELECT id FROM athletes WHERE last_name = 'Сорокина' AND first_name = 'Ольга' AND middle_name = 'Андреевна' AND birth_year = 2003), 4, 177, NULL, 62.8, (SELECT id FROM sport_ranks WHERE code = 'msmk'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 1001, '2025-06-12', 'Сорокина Ольга Андреевна', 'Спортивная школа', 'Нижегородская область', 1001, 10),
  (1343, 1031, (SELECT id FROM athletes WHERE last_name = 'Васькина' AND first_name = 'Алина' AND middle_name = 'Алексеевна' AND birth_year = 1999), 5, 169, NULL, 63.0, (SELECT id FROM sport_ranks WHERE code = 'msmk'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 1001, '2025-06-12', 'Васькина Алина Алексеевна', 'КСШ 1', 'Смоленская область', 1001, 10),
  (1344, 1031, (SELECT id FROM athletes WHERE last_name = 'Бурмакина' AND first_name = 'Екатерина' AND middle_name = 'Сергеевна' AND birth_year = 2005), 6, 165, NULL, 62.25, (SELECT id FROM sport_ranks WHERE code = 'msmk'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 1001, '2025-06-12', 'Бурмакина Екатерина Сергеевна', 'СШ «Тат-нефть Олимп»', 'Республика Татарстан', 1001, 10),
  (1345, 1031, (SELECT id FROM athletes WHERE last_name = 'Чеснокова' AND first_name = 'Екатерина' AND middle_name = 'Игоревна' AND birth_year = 1996), 7, 159, NULL, 62.1, (SELECT id FROM sport_ranks WHERE code = 'msmk'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 1001, '2025-06-12', 'Чеснокова Екатерина Игоревна', 'РО ООО "ВФГС" в г. Москве', 'г. Москва', 1001, 10),
  (1346, 1031, (SELECT id FROM athletes WHERE last_name = 'Барбакова' AND first_name = 'Александра' AND middle_name = 'Максимовна' AND birth_year = 2004), 8, 152, NULL, 58.85, (SELECT id FROM sport_ranks WHERE code = 'ms'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 1001, '2025-06-12', 'Барбакова Александра Максимовна', 'СШОР «Маршал»', 'Калужская область', 1001, 10),
  (1347, 1031, (SELECT id FROM athletes WHERE last_name = 'Горячкина' AND first_name = 'Лусине' AND middle_name = 'Рафиковна' AND birth_year = 1984), 9, 126, NULL, 61.45, (SELECT id FROM sport_ranks WHERE code = 'ms'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 1001, '2025-06-12', 'Горячкина Лусине Рафиковна', '"ПРОфитнес"', 'Краснодарский край', 1001, 10),
  (1348, 1031, (SELECT id FROM athletes WHERE last_name = 'Карпушенко' AND first_name = 'Ульяна' AND middle_name = 'Павловна' AND birth_year = 2001), 10, 126, NULL, 62.8, (SELECT id FROM sport_ranks WHERE code = 'ms'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 1001, '2025-06-12', 'Карпушенко Ульяна Павловна', 'Атлет', 'Челябинская область', 1001, 10),
  (1349, 1031, (SELECT id FROM athletes WHERE last_name = 'Коптяева' AND first_name = 'Карина' AND middle_name = 'Мансуровна' AND birth_year = 2007), 11, 126, NULL, 62.8, (SELECT id FROM sport_ranks WHERE code = 'ms'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 1001, '2025-06-12', 'Коптяева Карина Мансуровна', 'МАУ ДО "СШ 1" г.Тобольска', 'Тюменская область', 1001, 10),
  (1350, 1031, (SELECT id FROM athletes WHERE last_name = 'Щекина' AND first_name = 'Алина' AND middle_name = 'Игоревна' AND birth_year = 1996), 12, 121, NULL, 62.95, (SELECT id FROM sport_ranks WHERE code = 'kms'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 1001, '2025-06-12', 'Щекина Алина Игоревна', 'РСОО "ФГС РО"', 'Ростовская область', 1001, 10),
  (1351, 1031, (SELECT id FROM athletes WHERE last_name = 'Переплетова' AND first_name = 'Яна' AND middle_name = 'Васильевна' AND birth_year = 2009), 13, 120, NULL, 61.8, (SELECT id FROM sport_ranks WHERE code = 'kms'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 1001, '2025-06-12', 'Переплетова Яна Васильевна', 'ГБУ ДО МКСШОР «Запад» Отделение', 'г. Москва', 1001, 10),
  (1352, 1031, (SELECT id FROM athletes WHERE last_name = 'Шворак' AND first_name = 'Алёна' AND middle_name = 'Алексеевна' AND birth_year = 1994), 14, 107, NULL, 62.05, (SELECT id FROM sport_ranks WHERE code = 'kms'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 1001, '2025-06-12', 'Шворак Алёна Алексеевна', 'МКУ ДО "Бобровская СШ им. В.Л.', 'Воронежская область', 1001, 10),
  (1353, 1031, (SELECT id FROM athletes WHERE last_name = 'Калугина' AND first_name = 'Ирина' AND middle_name = 'Вячеславовна' AND birth_year = 2008), 15, 70, NULL, 62.85, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 1001, '2025-06-12', 'Калугина Ирина Вячеславовна', 'МБУДО "СШ" Сорочинского ГО', 'Оренбургская область', 1001, 10),
  (1354, 1032, (SELECT id FROM athletes WHERE last_name = 'Бенидзе' AND first_name = 'Елизавета' AND middle_name = 'Бадриевна' AND birth_year = 2002), 1, 203, NULL, 68.0, (SELECT id FROM sport_ranks WHERE code = 'msmk'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 1001, '2025-06-12', 'Бенидзе Елизавета Бадриевна', 'СПБ ГБУ ДО СШОРСВС им. В.Ф.', 'г. Санкт-Петербург', 1001, 9),
  (1355, 1032, (SELECT id FROM athletes WHERE last_name = 'Башарова' AND first_name = 'Виктория' AND middle_name = 'Васильевна' AND birth_year = 1993), 2, 202, NULL, 67.95, (SELECT id FROM sport_ranks WHERE code = 'msmk'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 1001, '2025-06-12', 'Башарова Виктория Васильевна', 'ВС', 'Республика Бурятия', 1001, 9),
  (1356, 1032, (SELECT id FROM athletes WHERE last_name = 'Барбакова' AND first_name = 'Наталья' AND middle_name = 'Александровна' AND birth_year = 1984), 3, 191, NULL, 67.5, (SELECT id FROM sport_ranks WHERE code = 'msmk'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 1001, '2025-06-12', 'Барбакова Наталья Александровна', 'СШОР Маршал', 'Калужская область', 1001, 9),
  (1357, 1032, (SELECT id FROM athletes WHERE last_name = 'Пименова' AND first_name = 'Татьяна' AND middle_name = 'Дмитриевна' AND birth_year = 1997), 4, 189, NULL, 67.75, (SELECT id FROM sport_ranks WHERE code = 'msmk'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 1001, '2025-06-12', 'Пименова Татьяна Дмитриевна', 'РО ООО "ВФГС" в Архангельской', 'Архангельская область', 1001, 9),
  (1358, 1032, (SELECT id FROM athletes WHERE last_name = 'Фирса' AND first_name = 'Анна' AND middle_name = 'Сергеевна' AND birth_year = 2003), 5, 181, NULL, 67.0, (SELECT id FROM sport_ranks WHERE code = 'msmk'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 1001, '2025-06-12', 'Фирса Анна Сергеевна', 'СШ Юность, ВС', 'Краснодарский край', 1001, 9),
  (1359, 1032, (SELECT id FROM athletes WHERE last_name = 'Кутенкова' AND first_name = 'Анастасия' AND middle_name = 'Михайловна' AND birth_year = 1997), 6, 160, NULL, 67.6, (SELECT id FROM sport_ranks WHERE code = 'ms'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 1001, '2025-06-12', 'Кутенкова Анастасия Михайловна', 'ВС', 'Республика Бурятия', 1001, 9),
  (1360, 1032, (SELECT id FROM athletes WHERE last_name = 'Потапова' AND first_name = 'Анастасия' AND middle_name = 'Михайловна' AND birth_year = 2004), 7, 149, NULL, 67.9, (SELECT id FROM sport_ranks WHERE code = 'ms'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 1001, '2025-06-12', 'Потапова Анастасия Михайловна', 'МАУ ДО ДЮЦ "Старт" города Тюмени', 'Тюменская область', 1001, 9),
  (1361, 1032, (SELECT id FROM athletes WHERE last_name = 'Обаранчук' AND first_name = 'Ксения' AND middle_name = 'Владимировна' AND birth_year = 2005), 8, 135, NULL, 66.9, (SELECT id FROM sport_ranks WHERE code = 'ms'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 1001, '2025-06-12', 'Обаранчук Ксения Владимировна', 'МБУ ДО «Центр Поиск»', 'Томская область', 1001, 9),
  (1362, 1032, (SELECT id FROM athletes WHERE last_name = 'Каприна' AND first_name = 'Наталья' AND middle_name = 'Владимировна' AND birth_year = 1980), 9, 117, NULL, 67.25, (SELECT id FROM sport_ranks WHERE code = 'kms'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 1001, '2025-06-12', 'Каприна Наталья Владимировна', '-', 'г. Москва', 1001, 9),
  (1363, 1032, (SELECT id FROM athletes WHERE last_name = 'Ельчанинова' AND first_name = 'Вероника' AND middle_name = 'Сергеевна' AND birth_year = 2003), 10, 114, NULL, 68.0, (SELECT id FROM sport_ranks WHERE code = 'kms'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 1001, '2025-06-12', 'Ельчанинова Вероника Сергеевна', 'СШОР 33', 'Омская область', 1001, 9),
  (1364, 1032, (SELECT id FROM athletes WHERE last_name = 'Верт' AND first_name = 'Елена' AND middle_name = 'Сергеевна' AND birth_year = 1991), 11, 113, NULL, 67.25, (SELECT id FROM sport_ranks WHERE code = 'kms'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 1001, '2025-06-12', 'Верт Елена Сергеевна', 'СПБ ГБУ ДО СШОРСВС им. В.Ф.', 'г. Санкт-Петербург', 1001, 9),
  (1365, 1032, (SELECT id FROM athletes WHERE last_name = 'Миронова' AND first_name = 'Василиса' AND middle_name = 'Александровна' AND birth_year = 2004), 12, 113, NULL, 67.65, (SELECT id FROM sport_ranks WHERE code = 'kms'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 1001, '2025-06-12', 'Миронова Василиса Александровна', 'МАУ ДО ДЮЦ "Старт" города Тюмени', 'Тюменская область', 1001, 9),
  (1366, 1032, (SELECT id FROM athletes WHERE last_name = 'Кошурникова' AND first_name = 'Анастасия' AND middle_name = 'Александровна' AND birth_year = 2003), 13, 100, NULL, 63.8, (SELECT id FROM sport_ranks WHERE code = 'kms'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 1001, '2025-06-12', 'Кошурникова Анастасия Александровна', 'МБУ ДО СШОР «Югория» им. А.А.', 'Ханты-Мансийский АО - Югра', 1001, 9),
  (1367, 1032, (SELECT id FROM athletes WHERE last_name = 'Коневец' AND first_name = 'Екатерина' AND middle_name = 'Антоновна' AND birth_year = 1986), 14, 100, NULL, 67.25, (SELECT id FROM sport_ranks WHERE code = 'kms'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 1001, '2025-06-12', 'Коневец Екатерина Антоновна', 'СШ "Заря"', 'Краснодарский край', 1001, 9),
  (1368, 1032, (SELECT id FROM athletes WHERE last_name = 'Сергеева' AND first_name = 'Юлия' AND middle_name = 'Александровна' AND birth_year = 1980), 15, 62, NULL, 66.5, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 1001, '2025-06-12', 'Сергеева Юлия Александровна', 'Федерация гиревого спорта г. Москвы', 'г. Москва', 1001, 9),
  (1369, 1032, (SELECT id FROM athletes WHERE last_name = 'Бофонова' AND first_name = 'Дарья' AND middle_name = 'Павловна' AND birth_year = 1991), 16, 26, NULL, 67.95, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 1001, '2025-06-12', 'Бофонова Дарья Павловна', 'РО ООО "ВФГС" в Нижегородской', 'Нижегородская область', 1001, 9),
  (1370, 1033, (SELECT id FROM athletes WHERE last_name = 'Кухарева' AND first_name = 'Мария' AND middle_name = 'Сергеевна' AND birth_year = 1989), 1, 210, NULL, 79.3, (SELECT id FROM sport_ranks WHERE code = 'msmk'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 1001, '2025-06-12', 'Кухарева Мария Сергеевна', 'СПБ ГБУ ДО СШОРСВС им. В.Ф.', 'г. Санкт-Петербург', 1001, 42),
  (1371, 1033, (SELECT id FROM athletes WHERE last_name = 'Мартынова' AND first_name = 'Ирина' AND middle_name = 'Александровна' AND birth_year = 1999), 2, 194, NULL, 84.7, (SELECT id FROM sport_ranks WHERE code = 'msmk'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 1001, '2025-06-12', 'Мартынова Ирина Александровна', 'СШОР «Маршал»', 'Калужская область', 1001, 42),
  (1372, 1033, (SELECT id FROM athletes WHERE last_name = 'Ходунова' AND first_name = 'Ирина' AND middle_name = 'Геннадьевна' AND birth_year = 1985), 3, 174, NULL, 85.0, (SELECT id FROM sport_ranks WHERE code = 'ms'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 1001, '2025-06-12', 'Ходунова Ирина Геннадьевна', 'КСШ 1', 'Смоленская область', 1001, 42),
  (1373, 1033, (SELECT id FROM athletes WHERE last_name = 'Островская' AND first_name = 'Надежда' AND middle_name = 'Аркадьевна' AND birth_year = 1985), 4, 166, NULL, 85.9, (SELECT id FROM sport_ranks WHERE code = 'ms'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 1001, '2025-06-12', 'Островская Надежда Аркадьевна', 'МБУ ДО СШОР «Югория» им. А.А.', 'Ханты-Мансийский АО - Югра', 1001, 42),
  (1374, 1033, (SELECT id FROM athletes WHERE last_name = 'Насонова' AND first_name = 'Виктория' AND middle_name = 'Борисовна' AND birth_year = 1999), 5, 163, NULL, 99.05, (SELECT id FROM sport_ranks WHERE code = 'ms'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 1001, '2025-06-12', 'Насонова Виктория Борисовна', 'СК «Победа»', 'Томская область', 1001, 42),
  (1375, 1033, (SELECT id FROM athletes WHERE last_name = 'Копылова' AND first_name = 'Регина' AND middle_name = 'Геннадьевна' AND birth_year = 2001), 6, 161, NULL, 93.1, (SELECT id FROM sport_ranks WHERE code = 'ms'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 1001, '2025-06-12', 'Копылова Регина Геннадьевна', 'ДЮСШ Искитимский р-н', 'Новосибирская область', 1001, 42),
  (1376, 1033, (SELECT id FROM athletes WHERE last_name = 'Врубель' AND first_name = 'Дарья' AND middle_name = 'Васильевна' AND birth_year = 2000), 7, 158, NULL, 95.05, (SELECT id FROM sport_ranks WHERE code = 'ms'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 1001, '2025-06-12', 'Врубель Дарья Васильевна', 'БУ ДО города Омска "СШОР 33"', 'Омская область', 1001, 42),
  (1377, 1033, (SELECT id FROM athletes WHERE last_name = 'Кузьмичева' AND first_name = 'Ксения' AND middle_name = 'Сергеевна' AND birth_year = 2004), 8, 153, NULL, 80.7, (SELECT id FROM sport_ranks WHERE code = 'ms'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 1001, '2025-06-12', 'Кузьмичева Ксения Сергеевна', 'СШ №1 им. Л.Д. Ковалевского', 'Оренбургская область', 1001, 42),
  (1378, 1033, (SELECT id FROM athletes WHERE last_name = 'Кашапова' AND first_name = 'Розана' AND middle_name = 'Фиргатовна' AND birth_year = 2001), 9, 142, NULL, 88.2, (SELECT id FROM sport_ranks WHERE code = 'kms'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 1001, '2025-06-12', 'Кашапова Розана Фиргатовна', 'МАУ ДО СШ «Буревестник»', 'Республика Башкортостан', 1001, 42),
  (1379, 1033, (SELECT id FROM athletes WHERE last_name = 'Круглова' AND first_name = 'Виктория' AND middle_name = 'Денисовна' AND birth_year = 2004), 10, 118, NULL, 76.25, (SELECT id FROM sport_ranks WHERE code = 'kms'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 1001, '2025-06-12', 'Круглова Виктория Денисовна', 'СШ "Юность"', 'Краснодарский край', 1001, 42),
  (1380, 1033, (SELECT id FROM athletes WHERE last_name = 'Карандеева' AND first_name = 'Юлия' AND middle_name = 'Александровна' AND birth_year = 2010), 11, 112, NULL, 84.9, (SELECT id FROM sport_ranks WHERE code = 'kms'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 1001, '2025-06-12', 'Карандеева Юлия Александровна', 'Спортивная школа "Легион"', 'г. Москва', 1001, 42),
  (1381, 1033, (SELECT id FROM athletes WHERE last_name = 'Макарова' AND first_name = 'Дарья' AND middle_name = 'Андреевна' AND birth_year = 2007), 12, 111, NULL, 82.8, (SELECT id FROM sport_ranks WHERE code = 'kms'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 1001, '2025-06-12', 'Макарова Дарья Андреевна', 'ГБУ ДО МКСШОР "Запад" Отделение', 'г. Москва', 1001, 42),
  (1382, 1033, (SELECT id FROM athletes WHERE last_name = 'Шумилейко' AND first_name = 'Ангелина' AND middle_name = 'Викторовна' AND birth_year = 2003), 13, 101, NULL, 70.85, (SELECT id FROM sport_ranks WHERE code = 'kms'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 1001, '2025-06-12', 'Шумилейко Ангелина Викторовна', 'Олимп', 'Челябинская область', 1001, 42),
  (1383, 1033, (SELECT id FROM athletes WHERE last_name = 'Сергеева' AND first_name = 'Вероника' AND middle_name = 'Алексеевна' AND birth_year = 2010), 14, 75, NULL, 76.6, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 1001, '2025-06-12', 'Сергеева Вероника Алексеевна', 'МБУ ДО СШ «Татнефть Олимп»', 'Республика Татарстан', 1001, 42),
  (1384, 1033, (SELECT id FROM athletes WHERE last_name = 'Киселева' AND first_name = 'Камила' AND middle_name = 'Алексеевна' AND birth_year = 2011), 15, 66, NULL, 74.55, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 1001, '2025-06-12', 'Киселева Камила Алексеевна', 'МБУ ДО СШ «Татнефть Олимп»', 'Республика Татарстан', 1001, 42);
