...
INSERT INTO categories (id, competition_id, discipline_id, sex, age_group_id, division_id, bell_kg, hands, time_limit_min, weight_class_raw, weight_class_kg, weight_class_is_open, participants_declared, is_deferred, sort_order) VALUES
  ...
  (8023, 8001, (SELECT id FROM disciplines WHERE code = 'snatch'), 'f', (SELECT id FROM age_groups WHERE code = 'adult'), NULL, 24, 'one', 10, '58', 58, 0, 8, 0, 23),
  (8024, 8001, (SELECT id FROM disciplines WHERE code = 'snatch'), 'f', (SELECT id FROM age_groups WHERE code = 'adult'), NULL, 24, 'one', 10, '63', 63, 0, 6, 0, 24),
  (8025, 8001, (SELECT id FROM disciplines WHERE code = 'snatch'), 'f', (SELECT id FROM age_groups WHERE code = 'adult'), NULL, 24, 'one', 10, '68+', 68, 1, 7, 0, 25),
  (8026, 8001, (SELECT id FROM disciplines WHERE code = 'snatch'), 'f', (SELECT id FROM age_groups WHERE code = 'adult'), NULL, 24, 'one', 10, '68', 68, 0, 8, 0, 26),
  (8027, 8001, (SELECT id FROM disciplines WHERE code = 'snatch'), 'm', (SELECT id FROM age_groups WHERE code = 'adult'), NULL, 32, 'one', 10, '63', 63, 0, 5, 0, 27),
  (8028, 8001, (SELECT id FROM disciplines WHERE code = 'snatch'), 'm', (SELECT id FROM age_groups WHERE code = 'adult'), NULL, 32, 'one', 10, '68', 68, 0, 4, 0, 28),
  (8029, 8001, (SELECT id FROM disciplines WHERE code = 'snatch'), 'm', (SELECT id FROM age_groups WHERE code = 'adult'), NULL, 32, 'one', 10, '73', 73, 0, 11, 0, 29),
  (8030, 8001, (SELECT id FROM disciplines WHERE code = 'snatch'), 'm', (SELECT id FROM age_groups WHERE code = 'adult'), NULL, 32, 'one', 10, '78', 78, 0, 10, 0, 30),
  (8031, 8001, (SELECT id FROM disciplines WHERE code = 'snatch'), 'm', (SELECT id FROM age_groups WHERE code = 'adult'), NULL, 32, 'one', 10, '85', 85, 0, 13, 0, 31),
  (8032, 8001, (SELECT id FROM disciplines WHERE code = 'snatch'), 'm', (SELECT id FROM age_groups WHERE code = 'adult'), NULL, 32, 'one', 10, '95+', 95, 1, 4, 0, 32),
  (8033, 8001, (SELECT id FROM disciplines WHERE code = 'snatch'), 'm', (SELECT id FROM age_groups WHERE code = 'adult'), NULL, 32, 'one', 10, '95', 95, 0, 11, 0, 33);
...
INSERT INTO results (id, category_id, athlete_id, place, total_reps, points, body_weight_kg, rank_achieved_id, discipline_id, bell_kg, hands, time_limit_min, competition_id, event_date, raw_name, raw_club, raw_region, protocol_id, source_page) VALUES
  ...
  (8119, 8023, (SELECT id FROM athletes WHERE last_name = 'Иванова' AND first_name = 'Алиса' AND middle_name = 'Валерьевна' AND birth_year = 1997 LIMIT 1), 1, 152, NULL, 56.68, (SELECT id FROM sport_ranks WHERE code = 'msmk'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 8001, '2026-04-13', 'Иванова Алиса Валерьевна', 'КСШ №1/ВС', 'Смоленская область', 8001, 35),
  (8120, 8023, (SELECT id FROM athletes WHERE last_name = 'Карцова' AND first_name = 'Татьяна' AND middle_name = 'Валерьевна' AND birth_year = 1981 LIMIT 1), 2, 136, NULL, 57.76, (SELECT id FROM sport_ranks WHERE code = 'ms'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 8001, '2026-04-13', 'Карцова Татьяна Валерьевна', 'РО ООО "ВФГС" в Московской области', 'Московская область', 8001, 35),
  (8121, 8023, (SELECT id FROM athletes WHERE last_name = 'Чернова' AND first_name = 'Кира' AND middle_name = 'Николаевна' AND birth_year = 2009 LIMIT 1), 3, 122, NULL, 56.7, (SELECT id FROM sport_ranks WHERE code = 'ms'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 8001, '2026-04-13', 'Чернова Кира Николаевна', 'СШОР «Маршал»', 'Калужская область', 8001, 35),
  (8122, 8023, (SELECT id FROM athletes WHERE last_name = 'Грибанова' AND first_name = 'Ирина' AND middle_name = 'Александровна' AND birth_year = 2004 LIMIT 1), 4, 114, NULL, 57.26, (SELECT id FROM sport_ranks WHERE code = 'kms'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 8001, '2026-04-13', 'Грибанова Ирина Александровна', 'КСШ № 1/СГУС', 'Смоленская область', 8001, 35),
  (8123, 8023, (SELECT id FROM athletes WHERE last_name = 'Конева' AND first_name = 'Лилия' AND middle_name = 'Алексеевна' AND birth_year = 2009 LIMIT 1), 5, 101, NULL, 57.26, (SELECT id FROM sport_ranks WHERE code = 'kms'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 8001, '2026-04-13', 'Конева Лилия Алексеевна', 'СШОР', 'Белгородская область', 8001, 35),
  (8124, 8023, (SELECT id FROM athletes WHERE last_name = 'Кудрявцева' AND first_name = 'Екатерина' AND middle_name = 'Геннадьевна' AND birth_year = 2000 LIMIT 1), 6, 89, NULL, 49.3, (SELECT id FROM sport_ranks WHERE code = 'kms'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 8001, '2026-04-13', 'Кудрявцева Екатерина Геннадьевна', 'МБУ ДО СШОР 5 г Белгород', 'Белгородская область', 8001, 35),
  (8125, 8023, (SELECT id FROM athletes WHERE last_name = 'Макрдумян' AND first_name = 'Виктория' AND middle_name = 'Валерьевна' AND birth_year = 1999 LIMIT 1), 7, 71, NULL, 57.88, (SELECT id FROM sport_ranks WHERE code = 'kms'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 8001, '2026-04-13', 'Макрдумян Виктория Валерьевна', 'МКУ ДО "Бобровская СШ им. В.Л. Паткина"', 'Воронежская область', 8001, 35),
  (8126, 8023, (SELECT id FROM athletes WHERE last_name = 'Новомлинцева' AND first_name = 'Мария' AND middle_name = 'Михайловна' AND birth_year = 2002 LIMIT 1), 8, 58, NULL, 57.8, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 8001, '2026-04-13', 'Новомлинцева Мария Михайловна', 'ГБУ ДО МКСШОР «Запад»', 'г. Москва', 8001, 35),
  (8127, 8024, (SELECT id FROM athletes WHERE last_name = 'Чеснокова' AND first_name = 'Екатерина' AND middle_name = 'Игоревна' AND birth_year = 1996 LIMIT 1), 1, 145, NULL, 62.45, (SELECT id FROM sport_ranks WHERE code = 'ms'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 8001, '2026-04-13', 'Чеснокова Екатерина Игоревна', 'ГБУ ДО МКСШОР "Запад" отделение "Семерка"', 'г. Москва', 8001, 36),
  (8128, 8024, (SELECT id FROM athletes WHERE last_name = 'Переплетова' AND first_name = 'Яна' AND middle_name = 'Васильевна' AND birth_year = 2009 LIMIT 1), 2, 120, NULL, 63.0, (SELECT id FROM sport_ranks WHERE code = 'kms'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 8001, '2026-04-13', 'Переплетова Яна Васильевна', 'ГБУ ДО МКСШОР «Запад» Отделение «Семёрка»', 'г. Москва', 8001, 36),
  (8129, 8024, (SELECT id FROM athletes WHERE last_name = 'Киселева' AND first_name = 'Мария' AND middle_name = 'Ивановна' AND birth_year = 1994 LIMIT 1), 3, 107, NULL, 62.1, (SELECT id FROM sport_ranks WHERE code = 'kms'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 8001, '2026-04-13', 'Киселева Мария Ивановна', 'МБУДО КСШ 1', 'Смоленская область', 8001, 36),
  (8130, 8024, (SELECT id FROM athletes WHERE last_name = 'Шворак' AND first_name = 'Алёна' AND middle_name = 'Алексеевна' AND birth_year = 1994 LIMIT 1), 4, 103, NULL, 62.4, (SELECT id FROM sport_ranks WHERE code = 'kms'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 8001, '2026-04-13', 'Шворак Алёна Алексеевна', 'МКУ ДО "Бобровская СШ им. В.Л. Паткина"', 'Воронежская область', 8001, 36),
  (8131, 8024, (SELECT id FROM athletes WHERE last_name = 'Анисимова' AND first_name = 'Елена' AND middle_name = 'Сергеевна' AND birth_year = 1996 LIMIT 1), 5, 54, NULL, 60.95, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 8001, '2026-04-13', 'Анисимова Елена Сергеевна', 'РО ООО ВФГС по гор. Москве', 'г. Москва', 8001, 36),
  (8132, 8024, (SELECT id FROM athletes WHERE last_name = 'Пивень' AND first_name = 'Александра' AND middle_name = 'Максимовна' AND birth_year = 2004 LIMIT 1), 6, 51, NULL, 60.1, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 8001, '2026-04-13', 'Пивень Александра Максимовна', 'СШОР «Маршал»', 'Калужская область', 8001, 36),
  (8133, 8025, (SELECT id FROM athletes WHERE last_name = 'Мартынова' AND first_name = 'Ирина' AND middle_name = 'Александровна' AND birth_year = 1999 LIMIT 1), 1, 208, NULL, 88.3, (SELECT id FROM sport_ranks WHERE code = 'msmk'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 8001, '2026-04-13', 'Мартынова Ирина Александровна', 'СШОР «Маршал»', 'Калужская область', 8001, 38),
  (8134, 8025, (SELECT id FROM athletes WHERE last_name = 'Ходунова' AND first_name = 'Ирина' AND middle_name = 'Геннадьевна' AND birth_year = 1985 LIMIT 1), 2, 154, NULL, 87.5, (SELECT id FROM sport_ranks WHERE code = 'ms'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 8001, '2026-04-13', 'Ходунова Ирина Геннадьевна', 'КСШ № 1/ ВС', 'Смоленская область', 8001, 38),
  (8135, 8025, (SELECT id FROM athletes WHERE last_name = 'Верховцева' AND first_name = 'Екатерина' AND middle_name = 'Николаевна' AND birth_year = 2003 LIMIT 1), 3, 143, NULL, 82.4, (SELECT id FROM sport_ranks WHERE code = 'kms'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 8001, '2026-04-13', 'Верховцева Екатерина Николаевна', 'МАУ ДО СШОР "Метеор"', 'Ярославская область', 8001, 38),
  (8136, 8025, (SELECT id FROM athletes WHERE last_name = 'Пылкина' AND first_name = 'Екатерина' AND middle_name = 'Михайловна' AND birth_year = 2002 LIMIT 1), 4, 141, NULL, 86.8, (SELECT id FROM sport_ranks WHERE code = 'kms'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 8001, '2026-04-13', 'Пылкина Екатерина Михайловна', 'КСШ № 1', 'Смоленская область', 8001, 38),
  (8137, 8025, (SELECT id FROM athletes WHERE last_name = 'Карандеева' AND first_name = 'Юлия' AND middle_name = 'Александровна' AND birth_year = 2010 LIMIT 1), 5, 130, NULL, 86.2, (SELECT id FROM sport_ranks WHERE code = 'kms'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 8001, '2026-04-13', 'Карандеева Юлия Александровна', 'МУ ДО "СШ "Легион"', 'Московская область', 8001, 38),
  (8138, 8025, (SELECT id FROM athletes WHERE last_name = 'Жилина' AND first_name = 'Марина' AND middle_name = 'Ивановна' AND birth_year = 1984 LIMIT 1), 6, 85, NULL, 120.65, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 8001, '2026-04-13', 'Жилина Марина Ивановна', 'МБУ ДО СШОР 5 г Белгород', 'Белгородская область', 8001, 38),
  (8139, 8025, (SELECT id FROM athletes WHERE last_name = 'Побережная' AND first_name = 'Анна' AND middle_name = 'Владимировна' AND birth_year = 2010 LIMIT 1), 7, 76, NULL, 78.85, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 8001, '2026-04-13', 'Побережная Анна Владимировна', 'СШОР "Маршал"', 'Калужская область', 8001, 38),
  (8140, 8026, (SELECT id FROM athletes WHERE last_name = 'Сорокина' AND first_name = 'Ольга' AND middle_name = 'Андреевна' AND birth_year = 2003 LIMIT 1), 1, 193, NULL, 66.2, (SELECT id FROM sport_ranks WHERE code = 'msmk'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 8001, '2026-04-13', 'Сорокина Ольга Андреевна', 'ГБУ ДО МКСШОР «Запад» Отделение «Семёрка»', 'г. Москва', 8001, 37),
  (8141, 8026, (SELECT id FROM athletes WHERE last_name = 'Барбакова' AND first_name = 'Наталья' AND middle_name = 'Александровна' AND birth_year = 1984 LIMIT 1), 2, 180, NULL, 68.0, (SELECT id FROM sport_ranks WHERE code = 'msmk'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 8001, '2026-04-13', 'Барбакова Наталья Александровна', 'СШОР МАРШАЛ', 'Калужская область', 8001, 37),
  (8142, 8026, (SELECT id FROM athletes WHERE last_name = 'Фирса' AND first_name = 'Анна' AND middle_name = 'Сергеевна' AND birth_year = 2003 LIMIT 1), 3, 162, NULL, 67.15, (SELECT id FROM sport_ranks WHERE code = 'ms'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 8001, '2026-04-13', 'Фирса Анна Сергеевна', 'ГБУ ДО МКСШОР «Запад» Отделение «Семёрка»', 'г. Москва', 8001, 37),
  (8143, 8026, (SELECT id FROM athletes WHERE last_name = 'Суменкова' AND first_name = 'Анастасия' AND middle_name = 'Дмитриевна' AND birth_year = 2009 LIMIT 1), 4, 117, NULL, 65.7, (SELECT id FROM sport_ranks WHERE code = 'kms'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 8001, '2026-04-13', 'Суменкова Анастасия Дмитриевна', 'МБУДО КСШ 1', 'Смоленская область', 8001, 37),
  (8144, 8026, (SELECT id FROM athletes WHERE last_name = 'Румянцева' AND first_name = 'Дарья' AND middle_name = 'Дмитриевна' AND birth_year = 2003 LIMIT 1), 5, 101, NULL, 65.5, (SELECT id FROM sport_ranks WHERE code = 'kms'), (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 8001, '2026-04-13', 'Румянцева Дарья Дмитриевна', 'ГБУ ДО МКСШОР «Запад» Отделение «Семёрка', 'г. Москва', 8001, 37),
  (8145, 8026, (SELECT id FROM athletes WHERE last_name = 'Кочубей' AND first_name = 'Жанна' AND middle_name = 'Александровна' AND birth_year = 1973 LIMIT 1), 6, 62, NULL, 65.9, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 8001, '2026-04-13', 'Кочубей Жанна Александровна', 'РО ООО "ВФГС" в Московской области', 'Московская область', 8001, 37),
  (8146, 8026, (SELECT id FROM athletes WHERE last_name = 'Снегирева' AND first_name = 'Варвара' AND middle_name = 'Андреевна' AND birth_year = 2011 LIMIT 1), 7, 50, NULL, 66.65, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 8001, '2026-04-13', 'Снегирева Варвара Андреевна', 'ГБУ ДО МКСШОР «ЗАПАД»', 'г. Москва', 8001, 37),
  (8147, 8026, (SELECT id FROM athletes WHERE last_name = 'Щекина' AND first_name = 'Анна' AND middle_name = 'Константиновна' AND birth_year = 2012 LIMIT 1), 8, 45, NULL, 66.5, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 24, 'one', 10, 8001, '2026-04-13', 'Щекина Анна Константиновна', 'МБУ ДО СШ "ОСКОЛ"', 'Белгородская область', 8001, 37),
  (8148, 8027, (SELECT id FROM athletes WHERE last_name = 'Арсентьев' AND first_name = 'Виталий' AND middle_name = 'Александрович' AND birth_year = 2001 LIMIT 1), 1, 146, NULL, 62.8, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 8001, '2026-04-13', 'Арсентьев Виталий Александрович', 'ЯРОО ФГС', 'Ярославская область', 8001, 28),
  (8149, 8027, (SELECT id FROM athletes WHERE last_name = 'Сушков' AND first_name = 'Андрей' AND middle_name = 'Васильевич' AND birth_year = 1992 LIMIT 1), 2, 120, NULL, 62.9, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 8001, '2026-04-13', 'Сушков Андрей Васильевич', 'МБУ ДО СШОР 5 г Белгород', 'Белгородская область', 8001, 28),
  (8150, 8027, (SELECT id FROM athletes WHERE last_name = 'Исаков' AND first_name = 'Станислав' AND middle_name = 'Алексеевич' AND birth_year = 2006 LIMIT 1), 3, 98, NULL, 62.5, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 8001, '2026-04-13', 'Исаков Станислав Алексеевич', 'КСШ №1/ВАВПВО', 'Смоленская область', 8001, 28),
  (8151, 8027, (SELECT id FROM athletes WHERE last_name = 'Кормилицын' AND first_name = 'Иван' AND middle_name = 'Николаевич' AND birth_year = 2010 LIMIT 1), 4, 85, NULL, 62.7, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 8001, '2026-04-13', 'Кормилицын Иван Николаевич', 'СШОР Маршал', 'Калужская область', 8001, 28),
  (8152, 8027, (SELECT id FROM athletes WHERE last_name = 'Буданов' AND first_name = 'Григорий' AND middle_name = 'Денисович' AND birth_year = 2010 LIMIT 1), 5, 40, NULL, 61.75, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 8001, '2026-04-13', 'Буданов Григорий Денисович', 'ГБУ ДО МКСШОР «Запад» Отделение «Семёрка»', 'г. Москва', 8001, 28),
  (8153, 8028, (SELECT id FROM athletes WHERE last_name = 'Петушков' AND first_name = 'Денис' AND middle_name = 'Владимирович' AND birth_year = 1986 LIMIT 1), 1, 140, NULL, 67.7, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 8001, '2026-04-13', 'Петушков Денис Владимирович', 'КСШ № 1', 'Смоленская область', 8001, 29),
  (8154, 8028, (SELECT id FROM athletes WHERE last_name = 'Хамидов' AND first_name = 'Фахриддин' AND middle_name = 'Фарход угли' AND birth_year = 2002 LIMIT 1), 2, 111, NULL, 68.0, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 8001, '2026-04-13', 'Хамидов Фахриддин Фарход угли', 'СШОР Маршал', 'Калужская область', 8001, 29),
  (8155, 8028, (SELECT id FROM athletes WHERE last_name = 'Горячев' AND first_name = 'Ярослав' AND middle_name = 'Алексеевич' AND birth_year = 2010 LIMIT 1), 3, 100, NULL, 67.9, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 8001, '2026-04-13', 'Горячев Ярослав Алексеевич', 'СШОР Маршал', 'Калужская область', 8001, 29),
  (8156, 8028, (SELECT id FROM athletes WHERE last_name = 'Копаевский' AND first_name = 'Артём' AND middle_name = 'Александрович' AND birth_year = 2009 LIMIT 1), 4, 93, NULL, 67.1, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 8001, '2026-04-13', 'Копаевский Артём Александрович', 'МАУ ДО СШОР "Метеор"', 'Ярославская область', 8001, 29),
  (8157, 8029, (SELECT id FROM athletes WHERE last_name = 'Сергеев' AND first_name = 'Александр' AND middle_name = 'Сергеевич' AND birth_year = 1991 LIMIT 1), 1, 172, NULL, 71.95, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 8001, '2026-04-13', 'Сергеев Александр Сергеевич', 'СШОР «Маршал»', 'Калужская область', 8001, 30),
  (8158, 8029, (SELECT id FROM athletes WHERE last_name = 'Балашов' AND first_name = 'Максим' AND middle_name = 'Юрьевич' AND birth_year = 1990 LIMIT 1), 2, 166, NULL, 72.95, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 8001, '2026-04-13', 'Балашов Максим Юрьевич', 'Ивановское региональное отделение', 'Ивановская область', 8001, 30),
  (8159, 8029, (SELECT id FROM athletes WHERE last_name = 'Савинов' AND first_name = 'Роман' AND middle_name = 'Сергеевич' AND birth_year = 1993 LIMIT 1), 3, 143, NULL, 70.7, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 8001, '2026-04-13', 'Савинов Роман Сергеевич', 'МАУ СШОР Метеор', 'Ярославская область', 8001, 30),
  (8160, 8029, (SELECT id FROM athletes WHERE last_name = 'Багров' AND first_name = 'Максим' AND middle_name = 'Дмитриевич' AND birth_year = 2009 LIMIT 1), 4, 131, NULL, 72.6, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 8001, '2026-04-13', 'Багров Максим Дмитриевич', 'РО ООО «ВФГС» в г. Москве', 'г. Москва', 8001, 30),
  (8161, 8029, (SELECT id FROM athletes WHERE last_name = 'Трофимов' AND first_name = 'Тимур' AND middle_name = 'Михайлович' AND birth_year = 2011 LIMIT 1), 5, 129, NULL, 73.0, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 8001, '2026-04-13', 'Трофимов Тимур Михайлович', 'СШОР "Маршал"', 'Калужская область', 8001, 30),
  (8162, 8029, (SELECT id FROM athletes WHERE last_name = 'Васин' AND first_name = 'Артём' AND middle_name = 'Иванович' AND birth_year = 2007 LIMIT 1), 6, 125, NULL, 72.3, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 8001, '2026-04-13', 'Васин Артём Иванович', 'СШОР "Маршал"', 'Калужская область', 8001, 30),
  (8163, 8029, (SELECT id FROM athletes WHERE last_name = 'Кобелев' AND first_name = 'Сергей' AND middle_name = 'Сергеевич' AND birth_year = 1987 LIMIT 1), 7, 115, NULL, 71.05, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 8001, '2026-04-13', 'Кобелев Сергей Сергеевич', 'РО ООО "ВФГС" во Владимирской области', 'Владимирская область', 8001, 30),
  (8164, 8029, (SELECT id FROM athletes WHERE last_name = 'Исмаилов' AND first_name = 'Артём' AND middle_name = 'Николаевич' AND birth_year = 2008 LIMIT 1), 8, 106, NULL, 69.7, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 8001, '2026-04-13', 'Исмаилов Артём Николаевич', 'МБУ ДО СШ "ОСКОЛ"', 'Белгородская область', 8001, 30),
  (8165, 8029, (SELECT id FROM athletes WHERE last_name = 'Науменко' AND first_name = 'Мирослав' AND middle_name = 'Константинович' AND birth_year = 2007 LIMIT 1), 9, 89, NULL, 72.8, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 8001, '2026-04-13', 'Науменко Мирослав Константинович', 'МАУ ДО СШОР "Метеор"', 'Ярославская область', 8001, 30),
  (8166, 8029, (SELECT id FROM athletes WHERE last_name = 'Евгиненков' AND first_name = 'Владимир' AND middle_name = 'Александрович' AND birth_year = 2009 LIMIT 1), 10, 81, NULL, 70.95, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 8001, '2026-04-13', 'Евгиненков Владимир Александрович', 'КСШ № 1', 'Смоленская область', 8001, 30),
  (8167, 8029, (SELECT id FROM athletes WHERE last_name = 'Лисицын' AND first_name = 'Кирилл' AND middle_name = 'Сергеевич' AND birth_year = 2007 LIMIT 1), 11, 67, NULL, 72.55, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 8001, '2026-04-13', 'Лисицын Кирилл Сергеевич', 'МАУ ДО СШОР "Метеор"', 'Ярославская область', 8001, 30),
  (8168, 8030, (SELECT id FROM athletes WHERE last_name = 'Ванин' AND first_name = 'Виктор' AND middle_name = 'Викторович' AND birth_year = 1991 LIMIT 1), 1, 180, NULL, 77.2, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 8001, '2026-04-13', 'Ванин Виктор Викторович', 'Ддю Алые паруса Ряжск', 'Рязанская область', 8001, 31),
  (8169, 8030, (SELECT id FROM athletes WHERE last_name = 'Дьячков' AND first_name = 'Олег' AND middle_name = 'Сергеевич' AND birth_year = 1995 LIMIT 1), 2, 176, NULL, 77.8, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 8001, '2026-04-13', 'Дьячков Олег Сергеевич', 'МБУ ДО СШОР 5 г Белгород', 'Белгородская область', 8001, 31),
  (8170, 8030, (SELECT id FROM athletes WHERE last_name = 'Гинда' AND first_name = 'Денис' AND middle_name = 'Петрович' AND birth_year = 1979 LIMIT 1), 3, 166, NULL, 75.25, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 8001, '2026-04-13', 'Гинда Денис Петрович', 'РО ООО «ВФГС» в г. Москве', 'г. Москва', 8001, 31),
  (8171, 8030, (SELECT id FROM athletes WHERE last_name = 'Спиридонов' AND first_name = 'Михаил' AND middle_name = 'Борисович' AND birth_year = 1988 LIMIT 1), 4, 136, NULL, 77.35, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 8001, '2026-04-13', 'Спиридонов Михаил Борисович', 'РО ООО "ВФГС" в городе Москве', 'г. Москва', 8001, 31),
  (8172, 8030, (SELECT id FROM athletes WHERE last_name = 'Сулейманов' AND first_name = 'Мовсар' AND middle_name = 'Мусаевич' AND birth_year = 1989 LIMIT 1), 5, 135, NULL, 78.0, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 8001, '2026-04-13', 'Сулейманов Мовсар Мусаевич', 'СШ Маршал', 'Калужская область', 8001, 31),
  (8173, 8030, (SELECT id FROM athletes WHERE last_name = 'Гордеев' AND first_name = 'Михаил' AND middle_name = 'Сергеевич' AND birth_year = 1998 LIMIT 1), 6, 110, NULL, 77.75, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 8001, '2026-04-13', 'Гордеев Михаил Сергеевич', 'РО ООО "ВФГС" в Московской области', 'Московская область', 8001, 31),
  (8174, 8030, (SELECT id FROM athletes WHERE last_name = 'Курбаков' AND first_name = 'Данила' AND middle_name = 'Александрович' AND birth_year = 2009 LIMIT 1), 7, 97, NULL, 78.0, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 8001, '2026-04-13', 'Курбаков Данила Александрович', 'СШОР Маршал', 'Калужская область', 8001, 31),
  (8175, 8030, (SELECT id FROM athletes WHERE last_name = 'Рассолов' AND first_name = 'Сергей' AND middle_name = 'Сергеевич' AND birth_year = 1990 LIMIT 1), 8, 92, NULL, 77.0, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 8001, '2026-04-13', 'Рассолов Сергей Сергеевич', 'МБУ ДО СШОР 5 г Белгород', 'Белгородская область', 8001, 31),
  (8176, 8030, (SELECT id FROM athletes WHERE last_name = 'Ладе' AND first_name = 'Роман' AND middle_name = 'Андреевич' AND birth_year = 1991 LIMIT 1), 9, 81, NULL, 77.9, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 8001, '2026-04-13', 'Ладе Роман Андреевич', 'РО ООО "ВФГС" в Московской области', 'Московская область', 8001, 31),
  (8177, 8030, (SELECT id FROM athletes WHERE last_name = 'Масленников' AND first_name = 'Иван' AND middle_name = 'Валерьевич' AND birth_year = 2011 LIMIT 1), 10, 50, NULL, 73.55, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 8001, '2026-04-13', 'Масленников Иван Валерьевич', 'МБУ ДО СШ "ОСКОЛ"', 'Белгородская область', 8001, 31),
  (8178, 8031, (SELECT id FROM athletes WHERE last_name = 'Ветров' AND first_name = 'Денис' AND middle_name = 'Сергеевич' AND birth_year = 1989 LIMIT 1), 1, 168, NULL, 84.8, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 8001, '2026-04-13', 'Ветров Денис Сергеевич', 'РО ООО «ВФГС» в г. Москве', 'г. Москва', 8001, 32),
  (8179, 8031, (SELECT id FROM athletes WHERE last_name = 'Бас' AND first_name = 'Денис' AND middle_name = 'Николаевич' AND birth_year = 2007 LIMIT 1), 2, 163, NULL, 83.7, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 8001, '2026-04-13', 'Бас Денис Николаевич', 'МБУ ДО СШОР 5 г Белгород/ МБУ ДО ДЮСШ Волоконовский район', 'Белгородская область', 8001, 32),
  (8180, 8031, (SELECT id FROM athletes WHERE last_name = 'Гнездилов' AND first_name = 'Роман' AND middle_name = 'Сергеевич' AND birth_year = 1990 LIMIT 1), 3, 160, NULL, 83.75, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 8001, '2026-04-13', 'Гнездилов Роман Сергеевич', 'Региональное отделение ВФГС по Курской области', 'Курская область', 8001, 32),
  (8181, 8031, (SELECT id FROM athletes WHERE last_name = 'Андрущенко' AND first_name = 'Сергей' AND middle_name = 'Александрович' AND birth_year = 2005 LIMIT 1), 4, 156, NULL, 84.25, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 8001, '2026-04-13', 'Андрущенко Сергей Александрович', 'ГБУ ДО МКСШОР "Запад" Отделение "Семёрка"', 'г. Москва, Белгородская область', 8001, 32),
  (8182, 8031, (SELECT id FROM athletes WHERE last_name = 'Мартысюк' AND first_name = 'Сергей' AND middle_name = 'Сергеевич' AND birth_year = 2010 LIMIT 1), 5, 150, NULL, 80.45, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 8001, '2026-04-13', 'Мартысюк Сергей Сергеевич', 'КСШ № 1', 'Смоленская область', 8001, 32),
  (8183, 8031, (SELECT id FROM athletes WHERE last_name = 'Шамара' AND first_name = 'Леонард' AND middle_name = 'Леонидович' AND birth_year = 1974 LIMIT 1), 6, 149, NULL, 82.8, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 8001, '2026-04-13', 'Шамара Леонард Леонидович', 'РО ООО ВФГС в г. Москве', 'г. Москва', 8001, 32),
  (8184, 8031, (SELECT id FROM athletes WHERE last_name = 'Кузовлев' AND first_name = 'Иван' AND middle_name = 'Николаевич' AND birth_year = 1985 LIMIT 1), 7, 132, NULL, 84.2, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 8001, '2026-04-13', 'Кузовлев Иван Николаевич', 'ЯРОО ФГС', 'Ярославская область', 8001, 32),
  (8185, 8031, (SELECT id FROM athletes WHERE last_name = 'Малашта' AND first_name = 'Роман' AND middle_name = 'Анатольевич' AND birth_year = 1987 LIMIT 1), 8, 131, NULL, 83.4, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 8001, '2026-04-13', 'Малашта Роман Анатольевич', 'МБУ ДО СШОР 5 г Белгород', 'Белгородская область', 8001, 32),
  (8186, 8031, (SELECT id FROM athletes WHERE last_name = 'Турищев' AND first_name = 'Михаил' AND middle_name = 'Михайлович' AND birth_year = 2007 LIMIT 1), 9, 99, NULL, 82.2, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 8001, '2026-04-13', 'Турищев Михаил Михайлович', 'ГБУ ДО МКСШОР «Запад» Отделение «Семёрка»', 'г. Москва', 8001, 32),
  (8187, 8031, (SELECT id FROM athletes WHERE last_name = 'Витков' AND first_name = 'Алексей' AND middle_name = 'Викторович' AND birth_year = 1990 LIMIT 1), 10, 95, NULL, 84.8, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 8001, '2026-04-13', 'Витков Алексей Викторович', 'РО ООО "ВФГС" в Московской области', 'Московская область', 8001, 32),
  (8188, 8031, (SELECT id FROM athletes WHERE last_name = 'Чернышев' AND first_name = 'Павел' AND middle_name = 'Вадимович' AND birth_year = 2007 LIMIT 1), 11, 91, NULL, 82.2, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 8001, '2026-04-13', 'Чернышев Павел Вадимович', 'ДДЮ Алые Паруса', 'Рязанская область', 8001, 32),
  (8189, 8031, (SELECT id FROM athletes WHERE last_name = 'Ларечнев' AND first_name = 'Алексей' AND middle_name = 'Викторович' AND birth_year = 1981 LIMIT 1), 12, 74, NULL, 81.25, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 8001, '2026-04-13', 'Ларечнев Алексей Викторович', 'Sapa Fitness', 'Смоленская область', 8001, 32),
  (8190, 8031, (SELECT id FROM athletes WHERE last_name = 'Насибов' AND first_name = 'Туран' AND middle_name = 'Гурбанович' AND birth_year = 2010 LIMIT 1), 13, 70, NULL, 78.45, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 8001, '2026-04-13', 'Насибов Туран Гурбанович', 'МБУ ДО СШ "ОСКОЛ"', 'Белгородская область', 8001, 32),
  (8191, 8032, (SELECT id FROM athletes WHERE last_name = 'Турищев' AND first_name = 'Дмитрий' AND middle_name = 'Владимирович' AND birth_year = 1992 LIMIT 1), 1, 190, NULL, 105.3, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 8001, '2026-04-13', 'Турищев Дмитрий Владимирович', 'ГБУ ДО МКСШОР "Запад" отделение "Семёрка"', 'г. Москва', 8001, 34),
  (8192, 8032, (SELECT id FROM athletes WHERE last_name = 'Симоненков' AND first_name = 'Андрей' AND middle_name = 'Игоревич' AND birth_year = 2001 LIMIT 1), 2, 160, NULL, 109.8, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 8001, '2026-04-13', 'Симоненков Андрей Игоревич', 'КСШ №1/ВАВПВО', 'Смоленская область', 8001, 34),
  (8193, 8032, (SELECT id FROM athletes WHERE last_name = 'Шишов' AND first_name = 'Михаил' AND middle_name = 'Александрович' AND birth_year = 1982 LIMIT 1), 3, 140, NULL, 99.6, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 8001, '2026-04-13', 'Шишов Михаил Александрович', 'РО ООО "ВФГС" во Владимирской области', 'Владимирская область', 8001, 34),
  (8194, 8032, (SELECT id FROM athletes WHERE last_name = 'Митрофанов' AND first_name = 'Тимофей' AND middle_name = 'Андреевич' AND birth_year = 2009 LIMIT 1), 4, 114, NULL, 118.65, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 8001, '2026-04-13', 'Митрофанов Тимофей Андреевич', 'МАУ ДО СШОР "Метеор"', 'Ярославская область', 8001, 34),
  (8195, 8033, (SELECT id FROM athletes WHERE last_name = 'Спесивцев' AND first_name = 'Данила' AND middle_name = 'Владимирович' AND birth_year = 2003 LIMIT 1), 1, 215, NULL, 88.65, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 8001, '2026-04-13', 'Спесивцев Данила Владимирович', 'МБУ ДО СШОР 5 г Белгород', 'Белгородская область', 8001, 33),
  (8196, 8033, (SELECT id FROM athletes WHERE last_name = 'Кирюхин' AND first_name = 'Роман' AND middle_name = 'Александрович' AND birth_year = 1997 LIMIT 1), 2, 214, NULL, 88.25, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 8001, '2026-04-13', 'Кирюхин Роман Александрович', 'ФГС КО', 'Калужская область', 8001, 33),
  (8197, 8033, (SELECT id FROM athletes WHERE last_name = 'Кулаков' AND first_name = 'Иван' AND middle_name = 'Иванович' AND birth_year = 1998 LIMIT 1), 3, 203, NULL, 94.65, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 8001, '2026-04-13', 'Кулаков Иван Иванович', 'СШОР «Маршал»', 'Калужская область', 8001, 33),
  (8198, 8033, (SELECT id FROM athletes WHERE last_name = 'Рыжков' AND first_name = 'Александр' AND middle_name = 'Егорович' AND birth_year = 1978 LIMIT 1), 4, 130, NULL, 90.0, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 8001, '2026-04-13', 'Рыжков Александр Егорович', '-', 'Курская область', 8001, 33),
  (8199, 8033, (SELECT id FROM athletes WHERE last_name = 'Карменов' AND first_name = 'Мажит' AND middle_name = 'Маратжанович' AND birth_year = 1986 LIMIT 1), 5, 129, NULL, 90.5, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 8001, '2026-04-13', 'Карменов Мажит Маратжанович', 'Динамо-24', 'г. Москва', 8001, 33),
  (8200, 8033, (SELECT id FROM athletes WHERE last_name = 'Булгаков' AND first_name = 'Денис' AND middle_name = 'Витальевич' AND birth_year = 1984 LIMIT 1), 6, 100, NULL, 86.0, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 8001, '2026-04-13', 'Булгаков Денис Витальевич', 'РО ООО "ВФГС" в Московской области', 'Московская область', 8001, 33),
  (8201, 8033, (SELECT id FROM athletes WHERE last_name = 'Белых' AND first_name = 'Александр' AND middle_name = 'Романович' AND birth_year = 2005 LIMIT 1), 7, 95, NULL, 93.9, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 8001, '2026-04-13', 'Белых Александр Романович', 'МБУ ДО СШОР 5 г Белгород', 'Белгородская область', 8001, 33),
  (8202, 8033, (SELECT id FROM athletes WHERE last_name = 'Кулик' AND first_name = 'Никита' AND middle_name = 'Алексеевич' AND birth_year = 2005 LIMIT 1), 8, 84, NULL, 94.1, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 8001, '2026-04-13', 'Кулик Никита Алексеевич', 'ГБУ ДО МКСШОР «Запад» Отделение «Семёрка»', 'г. Москва', 8001, 33),
  (8203, 8033, (SELECT id FROM athletes WHERE last_name = 'Брагин' AND first_name = 'Игорь' AND middle_name = 'Юрьевич' AND birth_year = 1991 LIMIT 1), 9, 79, NULL, 93.3, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 8001, '2026-04-13', 'Брагин Игорь Юрьевич', 'МБУ ДО СШОР 5 г Белгород', 'Белгородская область', 8001, 33),
  (8204, 8033, (SELECT id FROM athletes WHERE last_name = 'Янковский' AND first_name = 'Андрей' AND middle_name = 'Александрович' AND birth_year = 1994 LIMIT 1), 10, 76, NULL, 94.8, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 8001, '2026-04-13', 'Янковский Андрей Александрович', '«Гиревой Олимп»', 'Смоленская область', 8001, 33),
  (8205, 8033, (SELECT id FROM athletes WHERE last_name = 'Черных' AND first_name = 'Даниил' AND middle_name = 'Геннадьевич' AND birth_year = 2007 LIMIT 1), 11, 45, NULL, 88.2, NULL, (SELECT id FROM disciplines WHERE code = 'snatch'), 32, 'one', 10, 8001, '2026-04-13', 'Черных Даниил Геннадьевич', 'МБУ ДО СШ "ОСКОЛ"', 'Белгородская область', 8001, 33);
...
INSERT INTO result_reps (id, result_id, exercise, hand, reps) VALUES
  ...
  (8119, 8119, 'snatch', 'both', 152),
  (8120, 8120, 'snatch', 'both', 136),
  (8121, 8121, 'snatch', 'both', 122),
  (8122, 8122, 'snatch', 'both', 114),
  (8123, 8123, 'snatch', 'both', 101),
  (8124, 8124, 'snatch', 'both', 89),
  (8125, 8125, 'snatch', 'both', 71),
  (8126, 8126, 'snatch', 'both', 58),
  (8127, 8127, 'snatch', 'both', 145),
  (8128, 8128, 'snatch', 'both', 120),
  (8129, 8129, 'snatch', 'both', 107),
  (8130, 8130, 'snatch', 'both', 103),
  (8131, 8131, 'snatch', 'both', 54),
  (8132, 8132, 'snatch', 'both', 51),
  (8133, 8133, 'snatch', 'both', 208),
  (8134, 8134, 'snatch', 'both', 154),
  (8135, 8135, 'snatch', 'both', 143),
  (8136, 8136, 'snatch', 'both', 141),
  (8137, 8137, 'snatch', 'both', 130),
  (8138, 8138, 'snatch', 'both', 85),
  (8139, 8139, 'snatch', 'both', 76),
  (8140, 8140, 'snatch', 'both', 193),
  (8141, 8141, 'snatch', 'both', 180),
  (8142, 8142, 'snatch', 'both', 162),
  (8143, 8143, 'snatch', 'both', 117),
  (8144, 8144, 'snatch', 'both', 101),
  (8145, 8145, 'snatch', 'both', 62),
  (8146, 8146, 'snatch', 'both', 50),
  (8147, 8147, 'snatch', 'both', 45),
  (8148, 8148, 'snatch', 'both', 146),
  (8149, 8149, 'snatch', 'both', 120),
  (8150, 8150, 'snatch', 'both', 98),
  (8151, 8151, 'snatch', 'both', 85),
  (8152, 8152, 'snatch', 'both', 40),
  (8153, 8153, 'snatch', 'both', 140),
  (8154, 8154, 'snatch', 'both', 111),
  (8155, 8155, 'snatch', 'both', 100),
  (8156, 8156, 'snatch', 'both', 93),
  (8157, 8157, 'snatch', 'both', 172),
  (8158, 8158, 'snatch', 'both', 166),
  (8159, 8159, 'snatch', 'both', 143),
  (8160, 8160, 'snatch', 'both', 131),
  (8161, 8161, 'snatch', 'both', 129),
  (8162, 8162, 'snatch', 'both', 125),
  (8163, 8163, 'snatch', 'both', 115),
  (8164, 8164, 'snatch', 'both', 106),
  (8165, 8165, 'snatch', 'both', 89),
  (8166, 8166, 'snatch', 'both', 81),
  (8167, 8167, 'snatch', 'both', 67),
  (8168, 8168, 'snatch', 'both', 180),
  (8169, 8169, 'snatch', 'both', 176),
  (8170, 8170, 'snatch', 'both', 166),
  (8171, 8171, 'snatch', 'both', 136),
  (8172, 8172, 'snatch', 'both', 135),
  (8173, 8173, 'snatch', 'both', 110),
  (8174, 8174, 'snatch', 'both', 97),
  (8175, 8175, 'snatch', 'both', 92),
  (8176, 8176, 'snatch', 'both', 81),
  (8177, 8177, 'snatch', 'both', 50),
  (8178, 8178, 'snatch', 'both', 168),
  (8179, 8179, 'snatch', 'both', 163),
  (8180, 8180, 'snatch', 'both', 160),
  (8181, 8181, 'snatch', 'both', 156),
  (8182, 8182, 'snatch', 'both', 150),
  (8183, 8183, 'snatch', 'both', 149),
  (8184, 8184, 'snatch', 'both', 132),
  (8185, 8185, 'snatch', 'both', 131),
  (8186, 8186, 'snatch', 'both', 99),
  (8187, 8187, 'snatch', 'both', 95),
  (8188, 8188, 'snatch', 'both', 91),
  (8189, 8189, 'snatch', 'both', 74),
  (8190, 8190, 'snatch', 'both', 70),
  (8191, 8191, 'snatch', 'both', 190),
  (8192, 8192, 'snatch', 'both', 160),
  (8193, 8193, 'snatch', 'both', 140),
  (8194, 8194, 'snatch', 'both', 114),
  (8195, 8195, 'snatch', 'both', 215),
  (8196, 8196, 'snatch', 'both', 214),
  (8197, 8197, 'snatch', 'both', 203),
  (8198, 8198, 'snatch', 'both', 130),
  (8199, 8199, 'snatch', 'both', 129),
  (8200, 8200, 'snatch', 'both', 100),
  (8201, 8201, 'snatch', 'both', 95),
  (8202, 8202, 'snatch', 'both', 84),
  (8203, 8203, 'snatch', 'both', 79),
  (8204, 8204, 'snatch', 'both', 76),
  (8205, 8205, 'snatch', 'both', 45);
