...
python3 scripts/gen_seed_status.py data/chempionat-rossii-2018.json > "$BUILD_DIR/chempionat-rossii-2018.sql"
python3 scripts/gen_seed_status.py data/kubok-rossii-2018.json > "$BUILD_DIR/kubok-rossii-2018.sql"
python3 scripts/gen_seed_status.py data/chempionat-rossii-2019.json > "$BUILD_DIR/chempionat-rossii-2019.sql"
...
python3 scripts/gen_seed.py data/kubok-rossii-2019.json > "$BUILD_DIR/kubok-rossii-2019.sql"
...
cat \
  ...
  "$BUILD_DIR/chempionat-rossii-2018.sql" \
  "$BUILD_DIR/kubok-rossii-2018.sql" \
  "$BUILD_DIR/chempionat-rossii-2019.sql" \
  "$BUILD_DIR/kubok-rossii-2019.sql" \
